...
class TestCheckDatabaseConnection:
    ...
    def test_returns_true_on_success(self):
        ...
        with patch("stream_of_worship.app.services.sync.psycopg.connect", return_value=mock_conn):
    ...
    def test_returns_false_on_connect_failure(self):
        ...
        with patch(
            "stream_of_worship.app.services.sync.psycopg.connect",
    ...
    def test_uses_custom_timeout(self):
        ...
        with patch("stream_of_worship.app.services.sync.psycopg.connect") as mock_connect:
