...
## Corpus Check
- 806 files · ~677,795 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9630 nodes · 19463 edges · 416 communities (339 shown, 77 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 847 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `81672f2a`
...
## Communities (416 total, 77 thin omitted)

### Community 0 - "songs.ts"
Cohesion: 0.07
Nodes (57): GET(), GET(), AlbumFilterSchema, POST(), RequestSchema, FavoriteContext, loadFavoriteContext(), buildBpmPredicate() (+49 more)

### Community 1 - "ReadOnlyClient"
Cohesion: 0.04
Nodes (45): main(), Try to download LRC content from R2. Returns None if unavailable., _try_r2_lrc(), _keyword_search(), main(), _pgvector_search(), Semantic search using pgvector or theme-vocab fallback., Generate embedding for query and search via pgvector cosine distance. (+37 more)

### Community 2 - "useLocaleContext"
Cohesion: 0.08
...
Cohesion: 0.02
Nodes (86): build_db_client(), _print_dry_run(), Print dry run information showing what would be processed. Args: db_client:…, identify_editor_role(), Map a DB SongComponent to its editor-level role key, or None if not essential.…, Return the SongComponent that the currently-highlighted table row points at,…, DatabaseClient, Connection (+78 more)

### Community 4 - "audio.py"
Cohesion: 0.02
Nodes (276): Future, Lock, _accept_key(), adaptive_interval(), _advance_song(), _aggregate_recording_theme(), align_lrc_recording(), analyze_recording() (+268 more)
...
Cohesion: 0.09
Nodes (51): Counter, _bottleneck_lines(), _brief_summaries_prompt(), brief_summary_block(), build_review_report(), cache_narratives(), _candidate_pool_summary(), _config_flags() (+43 more)

### Community 8 - "LRCGenerator"
Cohesion: 0.16
Nodes (10): LRCGenerator, Path, Generate LRC file for a song. Args: audio_path: Path to audio file lyrics_text:…, Run Whisper ASR on audio file. Args: audio_path: Path to audio file Returns:…, Write LRC file. Args: lines: LRC lines to write output_path: Path to output file, Generate LRC files for multiple songs. Args: songs: List of (audio_path,…, Generate LRC files using Whisper + LLM alignment., Initialize LRC generator. Args: whisper_model: Whisper model name (default:… (+2 more)
...
### Community 11 - "ConnectionProvider"
Cohesion: 0.10
Nodes (16): _init_download_worker(), Per-thread initializer: create a ConnectionProvider + DatabaseClient. Called…, _get_connection_provider(), command, Path, Theme-anchors commands for sow-admin. Provides ``sow-admin theme-anchors sync``…, Populate the theme_anchors table from the bundled JSON file. Reads…, sync_theme_anchors() (+8 more)
...
### Community 14 - "cn"
Cohesion: 0.05
Nodes (58): formatDurationSafe(), isDifferent(), isIOS174OrLater(), PreviousRenderJobData, RenderForm(), RenderFormProps, TITLE_CARD_DURATIONS, FONT_PRESETS (+50 more)

### Community 15 - "R2Client"
Cohesion: 0.02
Nodes (132): _build_fresh_editor_state(), edit_lrc(), _get_alignment_lyrics_text(), _prompt_choice(), Return lyrics text for forced alignment, preferring existing LRC over nominal…, Interactively edit LRC timestamps for a song recording. Downloads/caches the…, Build a fresh EditorState from transcribed content or catalog lyrics., Prompt the user to choose from a list of options. Returns: Index of the chosen… (+124 more)

### Community 16 - "queue.py"
Cohesion: 0.05
Nodes (87): AnalyzeJobRequest, AnalyzeOptions, ComponentAnalysisJobRequest, ComponentAnalysisOptions, ComponentResult, EmbeddingJobRequest, EmbeddingJobResult, FastAnalyzeJobRequest (+79 more)
...
Cohesion: 0.05
Nodes (29): DEFAULT_SETTINGS, fetchSettings(), SettingsPage(), loadSettings(), RenderForm, RenderJobData, RenderPageClient(), RenderPageClientProps (+21 more)
...
Cohesion: 0.03
Nodes (72): geistMono, geistSans, metadata, RootLayout(), ResetPasswordPage(), PlayPage(), BottomNav(), navItems (+64 more)
...
Cohesion: 0.09
Nodes (36): identify_from_structured_lyrics(), _lines_match(), _normalize_for_matching(), Convert text to traditional Chinese via zhconv. ``祢`` (honorific "You" for God)…, Normalize a lyric line for structured-lyrics matching. Converts to traditional…, Exact normalized match OR rapidfuzz ratio > 85. Unlike the repetition path…, Identify song components by matching structured lyrics sections to LRC lines.…, _to_traditional() (+28 more)

### Community 26 - "SongsetClient"
Cohesion: 0.02
Nodes (111): AppConfig, ensure_app_config_exists(), get_app_config_dir(), get_app_config_path(), get_cache_dir(), Path, Configuration management for sow-app TUI. Manages app-specific settings for…, Cache directory - always at standard platform location. (+103 more)

### Community 27 - "BrowseSheet.tsx"
Cohesion: 0.06
Nodes (66): FavoritesClient(), loadPage(), FavoritesClientProps, HomePageClient(), HomePageClientProps, BrowseSheet, DashboardSongset, DashboardSongsetCard() (+58 more)
...
Cohesion: 0.10
Nodes (34): _assign_roles_by_energy(), ComponentInstance, compute_component_features(), _deserialize_components(), _detect_downbeats_madmom(), _detect_key_from_precomputed_chroma(), _detect_phrases_via_onset(), extract_components() (+26 more)

### Community 32 - "dashboard.ts"
Cohesion: 0.10
Nodes (28): addFavoriteSchema, GET(), POST(), FavoritesPage(), HomePage(), sql, songs, getCommunityFavoriteSample() (+20 more)

### Community 33 - "youtube_transcript.py"
Cohesion: 0.05
Nodes (49): _is_llm_rate_limited_error(), Detect whether an exception is an LLM 429 rate-limit error. Detection…, build_correction_prompt(), _build_proxy_config(), extract_video_id(), fetch_youtube_transcript(), _find_best_transcript(), _format_transcript_text() (+41 more)

### Community 34 - "ControllerPlayer.tsx"
Cohesion: 0.06
Nodes (31): LyricsEditor(), LyricsEditorProps, formatTime(), LyricsReviewSheet(), LyricsReviewSheetProps, TABS, TabType, clamp() (+23 more)
...
Cohesion: 0.05
Nodes (44): DELETE(), GET(), POST(), DELETE(), GET(), POST(), accounts, accountsRelations (+36 more)

### Community 43 - "SongsetEditor.tsx"
Cohesion: 0.04
Nodes (73): ShareDialog, ApiResponse, ApiSongset, ApiSongsetItem, ShareDialog, SongsetEditorClient(), SongsetEditorClientProps, transformItems() (+65 more)
...
Cohesion: 0.11
Nodes (19): SongsetItemSong, RenderScreenTest, detail(), FakeRenderRepository, FakeRenderSongsetsRepository, item(), job(), RenderFormConfig (+11 more)
...
Cohesion: 0.12
Nodes (52): main(), Shared constants mirroring the webapp's constants.ts. NOTE: these duplicate…, _draft_to_proposal(), DraftItem, JudgeItem, JudgeRanking, ProposalItem, BaseModel (+44 more)

### Community 53 - "t"
Cohesion: 0.10
Nodes (22): AboutContent(), AboutPage(), BuildStamp(), FEATURES, PublicLanding(), STEPS, formatDuration(), SharePage() (+14 more)

### Community 54 - "R2Client"
Cohesion: 0.06
Nodes (26): BackupFailedError, Exception, Path, R2Client, Upload analysis.json to R2. Args: hash_prefix: Content hash prefix for the path…, Upload lyrics.lrc to R2. Args: hash_prefix: Content hash prefix for the path…, Check if an object exists in R2. Args: s3_url: s3://bucket/key URL Returns:…, Check if a stem exists in R2, trying new name then legacy fallback. Args:… (+18 more)

### Community 55 - ".compose"
Cohesion: 0.12
Nodes (13): ComponentHeroPanel, _fmt_time(), PlaybackBar, ComposeResult, PlaybackService, R2Client, Static, Breadcrumb showing current song index, id, title, and hash_prefix. (+5 more)
...
### Community 57 - "messages.ts"
Cohesion: 0.05
Nodes (42): DEFAULTS, GET(), PUT(), VALID_FONT_PRESETS, VALID_FONTS, VALID_RESOLUTIONS, VALID_TEMPLATES, userSettings (+34 more)
...
Cohesion: 0.12
Nodes (40): diagnose_render_failures(), _format_datetime(), _json_default(), list_r2_waste(), list_soft_deletes(), _load_clients(), _load_r2(), _orphan_r2_prefixes() (+32 more)

### Community 66 - "section_segmenter.py"
Cohesion: 0.12
Nodes (30): identify_from_lyrics_repetition(), LyricsRepetitionWeights, _normalize_line(), Multi-cue scoring weights for identify_from_lyrics_repetition. Each field…, Snap a timestamp to the nearest beat. Args: time_seconds: Timestamp in seconds.…, Snap a timestamp to the nearest downbeat. Args: time_seconds: Timestamp in…, Normalize a lyric line for repetition comparison. Strips, lowercases, removes…, Identify chorus via repeated-line-group clustering on LRC lines. v3 — Multi-cue… (+22 more)

### Community 67 - "gen_lrc_qwen3_asr_mvsep_force_align_v2.py"
Cohesion: 0.07
Nodes (43): align_chunk(), assign_text_to_chunks(), build_aligned_text(), _compute_overlap_regions(), _count_cjk_chars(), detect_chinese_script(), extract_asr_text(), extract_segments() (+35 more)
...
Cohesion: 0.11
Nodes (29): DELETE(), GET(), createRenderJobSchema, POST(), reorderSchema, songsetItems, songsets, SONGSET_MAX_SONGS (+21 more)
...
Cohesion: 0.06
Nodes (35): { GET, POST }, DELETE(), DELETE(), GET(), GET(), GET(), RouteParams, auth (+27 more)
...
### Community 76 - "._guard_active_edit"
Cohesion: 0.23
Nodes (3): LyricLineTable, Lyrics table with preview-aware row navigation., Paste

### Community 77 - "index.ts"
Cohesion: 0.06
Nodes (48): clientErrorSchema, DELETE(), GET(), metaSchema, POST(), PUT(), runtime, GET() (+40 more)
...
Cohesion: 0.11
Nodes (30): BpmRangeMultiSelect(), MusicalKeyMultiSelect(), MusicalKeyMultiSelectProps, Avatar(), AvatarFallback(), avatarVariants, DropdownMenu(), DropdownMenuCheckboxItem() (+22 more)

### Community 83 - "ComponentEditorScreen"
Cohesion: 0.10
Nodes (14): CellHighlighted, CellSelected, ComponentEditorScreen, Any, Path, Resize, RowHighlighted, Submitted (+6 more)
...
### Community 90 - "OfflineStatus.tsx"
Cohesion: 0.20
Nodes (15): OfflineStatus(), OfflineStatusProps, ARTIFACT_CACHE_NAME, artifactCacheKey(), ArtifactCacheStatus, CacheableArtifacts, cacheArtifacts(), getArtifactCacheStatus() (+7 more)
...
Cohesion: 0.15
Nodes (25): LRCLine, _check_all_zero_draft(), _check_duplicate_timestamps(), _check_duration_sanity(), _check_monotonic_timestamps(), _check_preservation(), _generate_diff(), LRCLine (+17 more)
...
### Community 109 - "LRCEditorScreen"
Cohesion: 0.10
Nodes (8): LRCEditorScreen, DataTable, Path, PlaybackState, Resize, Submitted, Parse a timestamp input like [mm:ss.xx] or mm:ss.xx or seconds., Main interactive LRC editor screen. Provides: - Main lyrics preview area…
...
Cohesion: 0.04
Nodes (74): _is_retryable_poll_error(), lrc_recording(), Exception, Submit a recording for lyrics alignment (LRC generation). By default, tries…, Submit forced alignment for a single recording., Submit LRC for a single recording (original behavior with wait support)., Submit LRC for multiple recordings (batch mode, no wait)., Whether a polling failure should be retried once (transient). (+66 more)
...
Cohesion: 0.09
Nodes (41): android, Composable, Modifier, SowEmptyState(), SowErrorState(), SowLoadingState(), StatePanel(), label() (+33 more)
...
### Community 121 - "._refresh_lyrics_panel"
Cohesion: 0.20
...
Cohesion: 0.14
Nodes (10): Ingestion pipeline for Stream of Worship. This module provides tools for: -…, MetadataGenerator, AI metadata generation for worship songs. This module uses LLM to generate: -…, Generate metadata for a song. Args: title: Song title artist: Artist name…, Build the LLM prompt for metadata generation. Args: title: Song title artist:…, Get tempo category from BPM. Args: bpm: Beats per minute Returns: Tempo…, Filter themes to only valid ones. Args: themes: List of theme strings Returns:…, Generate AI metadata for worship songs using LLM. (+2 more)
...
Cohesion: 0.13
Nodes (24): AbstractEventLoop, _acquire_llm_slot(), call_llm_with_retry(), _enforce_llm_min_interval(), _extract_backoff_config(), _extract_json_from_text(), _extract_retry_after(), _extract_status_code() (+16 more)
...
### Community 129 - "TransitionBuilderApp"
Cohesion: 0.12
...
### Community 135 - "._guard_active_edit"
Cohesion: 0.15
...
### Community 138 - "stem_separation.py"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (38): Recording, Song, SongsPage, SongsetDetail, SongsetItem, SongsetItemRecording, SongsetsPage, SongsetSummary (+30 more)
...
Cohesion: 0.03
Nodes (112): Config, extract_lyrics_text(), generate_lrc_for_song(), generate_lrc_from_poc(), get_api_key(), get_audio_path(), load_analysis_for_song(), load_lyrics_for_song() (+104 more)
...
### Community 154 - "sow_analysis/config.py"
Cohesion: 0.12
Nodes (17): Service configuration using pydantic-settings., _classify_posture_heuristic(), _extract_lyrics_for_component(), has_cached_llm_fields(), _has_religious_pronoun(), _is_essential(), _lyric_hash(), LLM-based theme and vocal posture classification for song components. (+9 more)

### Community 155 - "Horizontal"
Cohesion: 0.07
Nodes (21): Horizontal, ComposeResult, Compose the screen layout., ComposeResult, Compose the screen layout., ComposeResult, Compose the screen layout., AppConfig (+13 more)
...
Cohesion: 0.16
Nodes (35): build_graph(), Build the songset constructor graph., choose_checkpointer(), Checkpointer selection — always InMemorySaver for v3., build_chat_model(), LLM construction and structured-output helpers., structured(), beam_seed_candidates() (+27 more)

### Community 164 - "FakePlayerController"
Cohesion: 0.06
Nodes (18): Error, IsPlayingChanged, PlaybackErrorKind, Decoder, Generic, PlayerController, PlayerEvent, PlayerEventListener (+10 more)

### Community 165 - "enrichment_report.py"
Cohesion: 0.11
Nodes (30): main(), test_beam_search(), main(), _shannon_entropy(), _bar(), build_enrichment_report(), _dominant_theme(), _phase_label() (+22 more)

### Community 166 - "token.test.ts"
Cohesion: 0.11
Nodes (14): DELETE(), activeShare, completedJob, mockCreateR2Client, mockEnforceRateLimit, mockFindFirstJob, mockFindFirstShare, mockGenerateSignedUrl (+6 more)
...
### Community 175 - "CatalogService"
Cohesion: 0.04
Nodes (41): build_correction_prompt(), extract_video_id(), format_timestamp(), format_transcript_text(), main(), parse_lrc_response(), command, Path (+33 more)
...
### Community 184 - "._get_selected_song"
Cohesion: 0.18
...
### Community 187 - "HistoryScreen"
Cohesion: 0.10
Nodes (15): HistoryScreen, AppState, PlaybackService, SongCatalogLoader, TransitionGenerationService, Vertical, Handle back button press., Handle play button press. (+7 more)
...
### Community 190 - "Path"
Cohesion: 0.15
Nodes (17): align_lyrics(), call_qwen3_asr(), _call_qwen3_asr_filetrans(), get_audio_duration(), get_model_cache_dir(), is_model_cached(), map_segments_to_lines(), Path (+9 more)

### Community 191 - "Json"
Cohesion: 0.03
Nodes (106): datetime, Json, delete_song(), _delete_song_single(), _delete_songs_batch(), edit_song(), _extract_series_sort_key(), insert_song() (+98 more)

### Community 192 - "frame_renderer.py"
Cohesion: 0.24
Nodes (10): _get_bool_env(), _get_int_env(), FontSizePreset, VideoTemplate, convert_to_global_timeline(), estimate_last_lyric_duration(), find_current_lyric_index(), get_lyrics_time_range() (+2 more)

### Community 193 - "LyricsErrorBoundary.test.tsx"
Cohesion: 0.17
Nodes (3): LyricsErrorBoundary, Props, State

### Community 194 - "parse_musical_key"
Cohesion: 0.20
Nodes (13): KeyMode, backfill_key_normalization(), _normalize_song_key_rows(), Backfill normalized catalog key fields on active songs., _update_key_normalization_batch(), _normalize_text(), parse_musical_key(), _parse_token() (+5 more)
...
### Community 196 - "Binding"
Cohesion: 0.18
Nodes (5): Binding, _BindingGroup, ComposeResult, Static, Text

### Community 197 - "._last_modified_to_str"
Cohesion: 0.11
...
### Community 199 - "share-token-cast-expiry.test.ts"
Cohesion: 0.15
...
Cohesion: 0.20
Nodes (12): backup_r2(), _bytes_to_mb(), _configure_r2_backup_debug_logging(), _print_backup_summary_table(), Console, Attach a DEBUG-level stderr handler to the r2_backup module logger. Idempotent:…, Backup entire R2 bucket to a local directory with chunked tar archives., Convert bytes to decimal MB (1 MB = 1,000,000 bytes), rounded to integer. (+4 more)
...
Cohesion: 0.12
Nodes (15): ActiveScreen, GenerationMode, PlaybackState, Enum, Application state model with playlist support., Available screens in application., Generation screen modes., App (+7 more)
...
### Community 213 - "tui/app.py"
Cohesion: 0.08
Nodes (25): Path, Main TUI application for Stream of Worship. This is the entry point for the…, Run the transition builder app with old-style config loading., Initialize the application. Args: config_path: Path to config.json, run_transition_builder(), Handle play button press., Initialize transition generation service. Args: output_dir: Directory for…, get_error_logger() (+17 more)
...
Cohesion: 0.03
Nodes (59): AudioSegment, Any, Update configuration values. Args: **kwargs: Key-value pairs to update, AppConfig, Initialize the application. Args: config: Application configuration, ExportProgressScreen, AppState, Pressed (+51 more)
...
Cohesion: 0.06
Nodes (30): Bundle, ComponentActivity, Modifier, SowApp(), SowNavigationBarItem(), SowShell(), AuthUser, AuthController (+22 more)

### Community 226 - "lrc_generator.py"
Cohesion: 0.22
Nodes (7): LRCLine, parse_lrc_file(), LRC generation pipeline using Whisper + LLM. This module handles the creation…, A single line in an LRC file., Snap timestamps to nearest beat grid. Args: lines: LRC lines to snap beats:…, Format as LRC line: [mm:ss.xx] text, Parse an LRC file. Args: path: Path to .lrc file Returns: List of LRC lines…

### Community 227 - "How the Render Worker Is Triggered from Next.js"
Cohesion: 0.22
...
### Community 228 - "useSongLyrics.ts"
Cohesion: 0.28
...
### Community 234 - "SongMetadata"
Cohesion: 0.25
Nodes (5): AI-generated metadata for a song., Generate metadata for multiple songs. Args: songs: List of (title, artist,…, Convert to dictionary., Create from dictionary., SongMetadata

### Community 235 - "plan_restore"
Cohesion: 0.29
...
### Community 240 - "._llm_align"
Cohesion: 0.40
Nodes (4): Use LLM to align scraped lyrics with Whisper timestamps. Args: lyrics_text:…, Format Whisper output for LLM prompt. Args: words: List of Whisper words…, A word with timestamp from Whisper output., WhisperWord

### Community 241 - "pipeline.py"
Cohesion: 0.18
Nodes (27): AssetFetcher, complete_render_job(), fail_render_job(), get_phase_index(), get_render_job(), _normalize_font_family(), Any, connection (+19 more)
...
Cohesion: 0.07
Nodes (49): BackupError, BackupResult, _build_extra_args(), build_inventory(), _build_manifest_object(), _check_disk_space(), _chunk_path(), _cleanup_owned_partial() (+41 more)
...
### Community 255 - "get_env_var_name"
Cohesion: 0.50
Nodes (4): get_env_var_name(), get_secret(), Get the environment variable name for a config key. Args: key: Configuration…, Get a secret value from environment variable. Args: key: Secret key (e.g.,…

### Community 256 - "PlaybackService"
Cohesion: 0.07
...
### Community 258 - "main"
Cohesion: 0.67
Nodes (3): main(), callback, sow-admin: Administrative tools for Stream of Worship. Manage song catalogs,…
...
### Community 273 - "AppState"
Cohesion: 0.04
Nodes (39): Transition data models., Parameters for generating a transition between two songs., Format generated time as HH:MM:SS., Return status indicator., Check if this is a gap transition., Check if this is a crossfade transition., Convert to dictionary for serialization., Represents a generated transition with metadata and parameters. (+31 more)

### Community 274 - "SongsetItem"
Cohesion: 0.18
...
### Community 281 - "._update_songs_table"
Cohesion: 0.33
...
Cohesion: 0.09
Nodes (25): ApiError, ApiErrorKind, Malformed, Network, Server, Unauthorized, Unknown, Validation (+17 more)
...
Cohesion: 0.16
Nodes (19): build_chapters_from_segments(), Chapter, ChapterLine, chapters_to_ffmpeg_metadata(), ChaptersManifest, dataclass_to_camel_case_dict(), find_chapter_at_time(), generate_chapters_manifest() (+11 more)
...
Cohesion: 0.10
Nodes (10): AssetFetcher, Path, R2Client, create_r2_client_from_env(), R2Client, infer_content_type(), R2Client, R2Uploader (+2 more)
...
Cohesion: 0.10
Nodes (23): _cache_age_hours(), main(), Load a cache file ignoring TTL (for stale fallback)., _try_load_stale(), event(), Trace event helpers for graph nodes., _cache_key(), _cache_path() (+15 more)
...
### Community 612 - "resolve_song_audio_path_mvsep"
Cohesion: 0.31
Nodes (10): download_files(), extract_vocals_two_stage_mvsep(), main(), poll_job(), Path, submit_job(), _find_local_dry_vocals(), Find locally cached dry vocals from MVSEP output directories. (+2 more)
