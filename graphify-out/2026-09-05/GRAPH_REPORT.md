# Graph Report - stream_of_worship  (2026-09-05)

## Corpus Check
- 806 files · ~677,196 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9628 nodes · 19459 edges · 447 communities (347 shown, 100 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 847 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3259f732`
...
## Communities (447 total, 100 thin omitted)
...
Cohesion: 0.04
Nodes (52): main(), Try to download LRC content from R2. Returns None if unavailable., _try_r2_lrc(), _keyword_search(), main(), _pgvector_search(), Semantic search using pgvector or theme-vocab fallback., Generate embedding for query and search via pgvector cosine distance. (+44 more)

### Community 3 - "DatabaseClient"
Cohesion: 0.02
Nodes (81): _print_dry_run(), Print dry run information showing what would be processed. Args: db_client:…, DatabaseClient, Connection, Recording, Song, Context manager for database transactions. Yields: psycopg connection with an…, Get a recording by its analysis or LRC job ID. Args: job_id: The job ID.… (+73 more)

### Community 4 - "audio.py"
Cohesion: 0.03
Nodes (129): _aggregate_recording_theme(), _apply_manifest_writeback(), _backfill_lyrics_batch(), _backfill_lyrics_for_song(), _build_fresh_editor_state(), _cancel_all_jobs(), cancel_jobs(), _cancel_single_job() (+121 more)
...
### Community 9 - "ConnectionProvider"
Cohesion: 0.02
Nodes (95): Connection health checker for sow-app. Re-exports the shared…, _display_stats(), _get_db_client(), init_db(), _mask_url(), command, Path, Database commands for sow-admin. Provides CLI commands for database… (+87 more)
...
### Community 11 - "R2Client"
Cohesion: 0.07
Nodes (45): Future, Lock, adaptive_interval(), _advance_song(), _compute_content_hash(), _confirm_r2_lrc(), _download_worker(), _get_alignment_lyrics_text() (+37 more)

### Community 12 - "SongCatalogLoader"
Cohesion: 0.13
Nodes (12): Path, Song, Song catalog loading and management., Loads and manages song catalog from JSON files., Compute a simple compatibility score between two songs. This is a placeholder…, Initialize catalog loader. Args: audio_folder: Path to folder containing audio…, Return the number of loaded songs., Load songs from a JSON file (output from poc_analysis_allinone.py). Args:… (+4 more)
...
### Community 14 - "cn"
Cohesion: 0.06
Nodes (76): LoginPage(), handleSubmit(), validate(), RegisterPage(), handleSubmit(), validate(), AuthLanguageSwitcher(), LABEL_KEY (+68 more)

### Community 15 - "editor/screen.py"
Cohesion: 0.06
Nodes (48): autosave_exists(), AutosaveState, clear_autosave(), get_autosave_path(), load_autosave(), Path, Autosave recovery for the admin LRC editor. Maintains an autosave recovery file…, Check whether an autosave recovery file exists. (+40 more)
...
Cohesion: 0.07
Nodes (30): FastAPI, Stream of Worship Analysis Service., lifespan(), main(), get, FastAPI application entry point., Root endpoint. Returns: Service info, Entry point for running the service directly. (+22 more)
...
Cohesion: 0.05
Nodes (39): ResetPasswordForm(), handleSubmit(), validate(), DEFAULT_SETTINGS, fetchSettings(), SettingsPage(), loadSettings(), ShareAudioPage() (+31 more)
...
Cohesion: 0.03
Nodes (72): ForgotPasswordPage(), handleSubmit(), validate(), geistMono, geistSans, metadata, RootLayout(), ResetPasswordPage() (+64 more)
...
### Community 25 - "Json"
Cohesion: 0.03
Nodes (134): AbstractEventLoop, Json, Service configuration using pydantic-settings., _extract_lyrics_for_component(), has_cached_llm_fields(), _is_essential(), _lyric_hash(), LLM-based theme and vocal posture classification for song components. (+126 more)
...
Cohesion: 0.06
Nodes (59): FavoritesClient(), FavoritesClientProps, HomePageClient(), HomePageClientProps, ShareDialog, DashboardSongset, ResultMode, SemanticSearch() (+51 more)
...
Cohesion: 0.05
Nodes (41): AudioPlayerBar(), LyricsErrorFallback(), GlobalAudioPlayer(), GlobalAudioPlayerProps, PlaybarRouteGuard(), ContainingSongset, LocateSongsetsPopover(), LyricsErrorBoundary (+33 more)
...
Cohesion: 0.08
Nodes (49): AboutPage(), addFavoriteSchema, GET(), POST(), loadPage(), FavoritesPage(), HomePage(), sql (+41 more)

### Community 33 - ".call"
Cohesion: 0.09
Nodes (20): _find_best_transcript(), _is_permanently_unavailable_error(), _is_rate_limited_error(), _is_transient_connection_error(), Any, Exception, Check if an exception is a transient connection-level error (SSL, network).…, Check if an exception indicates the video will never have a usable transcript.… (+12 more)

### Community 34 - "ControllerPlayer.tsx"
Cohesion: 0.06
Nodes (31): LyricsEditor(), LyricsEditorProps, formatTime(), LyricsReviewSheet(), LyricsReviewSheetProps, TABS, TabType, buildLrc() (+23 more)
...
### Community 38 - "lrc.py"
Cohesion: 0.04
Nodes (92): model_validator, LrcOptions, field_validator, Options for LRC generation jobs., Reject legacy field names that have been renamed., LLMConfigError, Exception, Base exception for worker errors. (+84 more)
...
Cohesion: 0.04
Nodes (46): DELETE(), GET(), POST(), DELETE(), GET(), POST(), accounts, accountsRelations (+38 more)

### Community 43 - "SongsetEditor.tsx"
Cohesion: 0.04
Nodes (63): PlayPage(), RenderJobData, SongsetData, SongsetItem, ApiResponse, ApiSongset, ApiSongsetItem, BrowseSheet (+55 more)
...
Cohesion: 0.15
Nodes (8): TUI Screens for sow-app. Textual screens for songset management, song browsing,…, LyricsPreviewScreen, Screen, Unregister playback callbacks to prevent leaks (Fix 8)., Start audio playback., Toggle playback with spacebar., Skip backward 10 seconds., Screen for previewing lyrics synchronized with audio playback.

### Community 48 - "Qwen3AsrClient"
Cohesion: 0.15
Nodes (9): Any, Exception, Path, Qwen3AsrClient, Qwen3AsrResult, Check if Qwen3 ASR is available for use. Returns: True when api_key is set,…, True if daily quota is exhausted (will reset at UTC midnight)., Reset quota-exhausted flag on new UTC day. (+1 more)
...
Cohesion: 0.07
Nodes (32): AboutContent(), BuildStamp(), FEATURES, PublicLanding(), STEPS, StatCard(), StatCardProps, isIOSLessThan174() (+24 more)
...
Cohesion: 0.04
Nodes (49): PlaybackService, Textual app for the admin Component Metadata editor., identify_editor_role(), Constants for the Component Metadata editor TUI (v6). v6 changes from v5: - New…, Map a DB SongComponent to its editor-level role key, or None if not essential.…, Component Detail Panel widget for the Component Metadata editor (v6). Right…, fetch_lrc_for_song(), LRCFetch (+41 more)
...
Cohesion: 0.05
Nodes (48): { GET, POST }, DELETE(), DELETE(), GET(), DEFAULTS, GET(), PUT(), VALID_FONT_PRESETS (+40 more)
...
Cohesion: 0.07
Nodes (45): analyze_audio(), analyze_audio_fast(), compute_loudness(), _compute_tempo_v4(), _compute_tempo_v5(), detect_key(), detect_key_fulltrack(), detect_key_segment_vote() (+37 more)

### Community 65 - "maintenance.py"
Cohesion: 0.08
Nodes (58): backfill_key_normalization(), backup_r2(), _bytes_to_mb(), _configure_r2_backup_debug_logging(), diagnose_render_failures(), _format_datetime(), _json_default(), list_r2_waste() (+50 more)

### Community 66 - "SongList.tsx"
Cohesion: 0.15
Nodes (17): FavoriteButton(), escapeCssSelectorValue(), SongList(), SongListItem, SongListProps, SortableSongItem(), SortableSongItemProps, getCompletedSongIds() (+9 more)
...
Cohesion: 0.13
Nodes (21): PlayerLyricsPanel(), PlayerLyricsPanelProps, LyricsTimingEditorProps, CachedResult, clearLyricsCache(), lyricsCache, NULL_RESULT, SongLyricsResult (+13 more)
...
Cohesion: 0.06
Nodes (47): formatDuration(), PublicSongsetItem, ShareData, SharePage(), DashboardSongsetCard(), DashboardSongsetCardProps, BpmRangeMultiSelect(), BpmRangeMultiSelectProps (+39 more)
...
Cohesion: 0.11
Nodes (26): OfflineStatus(), OfflineStatusProps, FavoriteButtonProps, ADR-0002, RenderStatusBadge(), RenderStatusBadgeProps, STATE_CONFIG, Badge() (+18 more)
...
Cohesion: 0.07
Nodes (45): LRCLine, Lyrics Panel widget for the Component Metadata editor (v6). Right panel (lyrics…, _check_all_zero_draft(), _check_duplicate_timestamps(), _check_duration_sanity(), _check_monotonic_timestamps(), _check_preservation(), _generate_diff() (+37 more)
...
### Community 107 - "ProjectionPlayer.tsx"
Cohesion: 0.18
...
Cohesion: 0.04
Nodes (69): analyze_recording(), _handle_analysis_completion(), Submit a recording for analysis. By default, submits fast analysis (librosa-…, Submit forced alignment for a single recording., Process a completed/failed analysis job. Returns ``(is_terminal, new_job_id)``., _submit_forced_alignment_single(), _batch_lookup_analysis(), _batch_lookup_r2() (+61 more)
...
Cohesion: 0.10
Nodes (32): construct_songset(), _dedupe_songset_name(), _format_duration(), Sanitize a song title for use in an auto-generated songset name. Strips…, Append ``_2``, ``_3``, … to ``name`` until it is not in ``existing_names``. If…, Format seconds as ``M:SS`` (or ``--:--`` if None). Args: seconds: Duration in…, _sanitize_title_for_name(), create_songset() (+24 more)
...
Cohesion: 0.14
Nodes (16): build_chat_model_for_lyrics(), _build_lyrics_prompt(), extract_structured_lyrics_with_llm(), _is_trailing_non_lyric(), parse_structured_lyrics(), BaseModel, Parser for structured (section-tagged) lyrics from YouTube descriptions.…, A single section of structured lyrics (e.g. Verse, Chorus). (+8 more)
...
Cohesion: 0.18
Nodes (10): ShareControllerPage(), loadData(), ControllerPage(), loadData(), SongsetData, LyricJumpListProps, CastCommandTarget, dispatchCast() (+2 more)
...
Cohesion: 0.05
Nodes (36): label(), RenderState, Failed, Fresh, Rendering, Stale, Unrendered, Recording (+28 more)
...
### Community 149 - "PlayerController"
Cohesion: 0.10
...
Cohesion: 0.11
Nodes (7): LRCEditorScreen, Path, Resize, RowHighlighted, Main interactive LRC editor screen. Provides: - Main lyrics preview area…, Update the lyric banner for preview, where -1 means blank before line 1., Find the lyric line index for the current playback position.

### Community 154 - "canonical_snap.py"
Cohesion: 0.26
Nodes (11): _bucket_to_phrase(), _canonical_lines(), _FallbackFuzz, _normalize(), _phrases_from_words(), Snap ASR phrases to canonical lyric lines., Snap Qwen ASR phrases to canonical lyrics without deduplicating repeats., snap_qwen3_asr_to_canonical() (+3 more)

### Community 155 - "Horizontal"
Cohesion: 0.07
Nodes (20): Horizontal, AppState, PlaybackService, SongCatalogLoader, TransitionGenerationService, Vertical, Initialize generation screen. Args: state: Application state catalog: Song…, Build the screen layout. (+12 more)
...
### Community 181 - "._create_screen"
Cohesion: 0.33
Nodes (3): Switch to a named screen. Args: screen_name: Name of the screen to switch to, Handle app mount event., Create a screen instance by name. Args: screen_name: Name of the screen…
...
Cohesion: 0.03
Nodes (97): delete_song(), _delete_song_single(), _delete_songs_batch(), edit_song(), _extract_series_sort_key(), insert_song(), list_songs(), _print_duplicate_guidance() (+89 more)

### Community 192 - "qwen3_asr_client.py"
Cohesion: 0.26
Nodes (9): Qwen3AsrError, Qwen3AsrNonRetriableError, Qwen3AsrQuotaExhaustedError, Qwen3AsrTimeoutError, DashScope Qwen3 ASR client for LRC transcription., Base error for Qwen3 ASR failures., Raised for auth/configuration errors that should not be retried., Raised when DashScope does not complete before timeout. (+1 more)

### Community 193 - "PlayerScreen.kt"
Cohesion: 0.31
...
Cohesion: 0.04
Nodes (31): Path, R2Client, Upload an audio file to R2 under the hash-prefix directory. The file is stored…, Validate and normalize a full recording hash prefix., Return the exact R2 prefix for a recording hash., List objects under an exact recording prefix using 100-object pages., Delete all objects under an exact recording prefix in 100-object batches., List objects under ``{prefix}/stems/`` for a recording. Args: prefix:… (+23 more)
...
### Community 199 - ".load"
Cohesion: 0.05
Nodes (77): _accept_key(), align_lrc_recording(), batch(), cache_assets(), check_status(), _colorize_visibility(), components_recording(), _display_truncate() (+69 more)
...
### Community 202 - "._load_assets_worker"
Cohesion: 0.20
...
### Community 217 - "stem_separation.py"
Cohesion: 0.05
...
Cohesion: 0.10
Nodes (25): _get_bool_env(), _get_int_env(), FontSizePreset, TitleCardConfig, VideoTemplate, convert_to_global_timeline(), estimate_last_lyric_duration(), find_current_lyric_index() (+17 more)
...
### Community 230 - "SongsetItemWithDetails"
Cohesion: 0.20
...
### Community 231 - "._ensure_ready"
Cohesion: 0.24
Nodes (5): Path, Run two-stage stem separation. Stage 1: Extract vocals and instrumental Stage…, Run Stage 2 only: remove echo/reverb from vocals using UVR-De-Echo. Used as a…, Lazily initialize models on first use. Thread-safe via lock., Validate model availability by loading then discarding instances. Confirms both…
...
### Community 234 - "._refresh_hero"
Cohesion: 0.31
Nodes (4): CellHighlighted, CellSelected, RowHighlighted, v4 NEW. Re-renders the ComponentHeroPanel against the current state.
...
### Community 236 - "How the Render Worker Is Triggered from Next.js"
Cohesion: 0.22
...
### Community 240 - ".action_lyrics_preview"
Cohesion: 0.22
...
Cohesion: 0.33
Nodes (3): SQL schema for per-user app tables. Tables we own that are scoped to a user via…, SQL schema for Better Auth core tables. Defines the canonical Better Auth…, Unified PostgreSQL schema for Stream of Worship. Combines catalog (songs,…

### Community 248 - "r2_backup.py"
Cohesion: 0.05
Nodes (57): BackupError, BackupResult, _build_extra_args(), build_inventory(), _build_manifest_object(), _check_disk_space(), _chunk_path(), _cleanup_owned_partial() (+49 more)
...
### Community 250 - ".on_input_blurred"
Cohesion: 0.25
...
### Community 251 - "usePresentation.ts"
Cohesion: 0.18
...
### Community 255 - ".generate_full_song"
Cohesion: 0.25
...
Cohesion: 0.03
Nodes (54): App, Path, Main TUI application for Stream of Worship. This is the entry point for the…, Get or create the history screen., Get or create the playlist screen., Switch to a named screen. Args: screen_name: Name of the screen ('generation',…, Handle app mount event., Quit the application with cleanup. (+46 more)

### Community 274 - ".to_dict"
Cohesion: 0.40
...
### Community 277 - "OfflinePlaybackState"
Cohesion: 0.33
...
### Community 305 - "._populate_lrc_table"
Cohesion: 0.33
...
### Community 308 - ".on_screen_resume"
Cohesion: 0.33
Nodes (3): ScreenResume, Handle selected_songset state change., Handle screen resume (when returning from browse/add songs).

### Community 310 - "._key_to_attr"
Cohesion: 0.33
Nodes (3): Get a configuration value by key. Supports dot notation mapping to flat…, Set a configuration value by key. Supports dot notation mapping to flat…, Convert dot-notation key to attribute name. Maps TOML section paths to flat…
...
Cohesion: 0.02
Nodes (140): datetime, Main TUI application for Stream of Worship User App. Textual-based application…, AppConfig, ensure_app_config_exists(), get_app_config_dir(), get_app_config_path(), get_cache_dir(), Path (+132 more)

### Community 387 - "JobQueue"
Cohesion: 0.04
Nodes (48): Set the current job_id in the context. Args: job_id: Job ID to set, or None to…, set_job_id(), Job, Represents a job in the queue., format_timestamp(), map_segments_to_lines(), normalize_text(), Path (+40 more)

### Community 396 - ".update_display"
Cohesion: 0.40
Nodes (3): PlaybackPosition, Update the progress bar display. Called by the parent screen from its…, Format seconds as M:SS.

### Community 398 - "API Endpoints"
Cohesion: 0.40
