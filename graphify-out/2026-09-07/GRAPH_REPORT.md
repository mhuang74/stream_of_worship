# Graph Report - sow_ios_full_screen_fix  (2026-09-07)

## Corpus Check
- 809 files · ~679,472 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9642 nodes · 19484 edges · 411 communities (337 shown, 74 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 850 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c350798b`
...
## Communities (411 total, 74 thin omitted)

### Community 0 - "songs.ts"
Cohesion: 0.07
Nodes (66): GET(), GET(), AlbumFilterSchema, POST(), RequestSchema, sql, songs, FavoriteContext (+58 more)
...
Cohesion: 0.08
Nodes (26): geistMono, geistSans, metadata, RootLayout(), GlobalAudioPlayer(), BottomNav(), Header(), Avatar() (+18 more)

### Community 3 - "DatabaseClient"
Cohesion: 0.01
Nodes (139): build_db_client(), _print_dry_run(), Print dry run information showing what would be processed. Args: db_client:…, Textual app for the admin Component Metadata editor., identify_editor_role(), Constants for the Component Metadata editor TUI (v6). v6 changes from v5: - New…, Map a DB SongComponent to its editor-level role key, or None if not essential.…, Component Detail Panel widget for the Component Metadata editor (v6). Right… (+131 more)

### Community 4 - "audio.py"
Cohesion: 0.02
Nodes (176): Future, Lock, adaptive_interval(), _advance_song(), _aggregate_recording_theme(), _apply_manifest_writeback(), _backfill_lyrics_batch(), _backfill_lyrics_for_song() (+168 more)
...
Cohesion: 0.03
Nodes (85): _display_stats(), _get_db_client(), init_db(), _mask_url(), command, Path, Database commands for sow-admin. Provides CLI commands for database…, Print the connection info table; return True if the database is reachable. (+77 more)
...
### Community 14 - "cn"
Cohesion: 0.05
Nodes (61): formatTime(), LyricsReviewSheet(), LyricsReviewSheetProps, TABS, TabType, formatDurationSafe(), isDifferent(), isIOS174OrLater() (+53 more)
...
Cohesion: 0.03
Nodes (107): AnalyzeJobRequest, AnalyzeOptions, ComponentAnalysisJobRequest, ComponentAnalysisOptions, ComponentResult, EmbeddingJobRequest, EmbeddingJobResult, FastAnalyzeJobRequest (+99 more)
...
Cohesion: 0.16
Nodes (12): RenderForm, RenderJobData, RenderPageClient(), RenderPageClientProps, RenderScreenState, RenderState, RenderSubmitted, SongsetData (+4 more)
...
Cohesion: 0.03
Nodes (60): ForgotPasswordPage(), handleSubmit(), validate(), ResetPasswordPage(), fetchSettings(), SettingsPage(), loadSettings(), OfflineIndicator() (+52 more)

### Community 23 - "r2/client.ts"
Cohesion: 0.04
Nodes (40): GET(), GET(), GET(), GET(), POST(), signedUrlRequestSchema, generateSignedUrlResponse(), SignedUrlParams (+32 more)
...
### Community 25 - "TransitionParams"
Cohesion: 0.08
Nodes (15): PlaylistItem, Playlist data models for multi-song support., A single item in a playlist (song + transition to next)., Update transition for a song. Args: index: Index of song to update transition…, Get transition for a song. Args: index: Index of song to get transition for…, Calculate duration based on section selection. For now, returns full song…, Convert to dictionary for serialization., Create from dictionary. (+7 more)

### Community 26 - "SongsetClient"
Cohesion: 0.04
Nodes (35): AppState, PlaybackService, Initialize the screen. Args: state: Application state songset_client: Songset…, Get a songset with resolved items using batch queries (Fix 10). Steps: 1. Fetch…, Any, Initialize the songset IO service. Args: songset_client: SongsetClient for…, Create a SongsetItem from a database row tuple. Args: row: Database row tuple…, NotOwnerError (+27 more)
...
Cohesion: 0.06
Nodes (24): Playlist, PlaylistMetadata, Path, Create from dictionary., A complete playlist containing multiple songs and transitions., Initialize default values., Get total playlist duration in seconds., Get number of songs in playlist. (+16 more)

### Community 30 - "AudioPlayerContext.tsx"
Cohesion: 0.06
Nodes (46): AudioPlayerBar(), LyricsErrorFallback(), GlobalAudioPlayerProps, PlaybarRouteGuard(), ContainingSongset, LocateSongsetsPopover(), FavoriteButton(), Popover() (+38 more)

### Community 31 - "components.py"
Cohesion: 0.02
Nodes (162): AbstractEventLoop, _classify_posture_heuristic(), _extract_lyrics_for_component(), has_cached_llm_fields(), _has_religious_pronoun(), _is_essential(), _lyric_hash(), LLM-based theme and vocal posture classification for song components. (+154 more)

### Community 32 - "constants.ts"
Cohesion: 0.06
Nodes (69): FavoritesClientProps, ResultMode, SemanticSearchProps, SemanticSearchResult, UseSemanticSearchOptions, AlbumMultiSelect(), AlbumMultiSelectProps, BpmRangeMultiSelect() (+61 more)
...
Cohesion: 0.05
Nodes (62): LyricsResponse, ALLOWED_FILES, CONTENT_TYPES, FILE_TYPES, GET(), RouteParams, POST(), createSongsetItemSchema (+54 more)

### Community 36 - "SongsetEditor.tsx"
Cohesion: 0.14
Nodes (16): Alert(), AlertAction(), AlertDescription(), AlertTitle(), alertVariants, Dialog(), DialogContent(), DialogDescription() (+8 more)
...
### Community 42 - "SettingsForm.tsx"
Cohesion: 0.12
Nodes (12): FONT_PRESETS, GAP_BEATS_OPTIONS, isIOSLessThan174(), KEY_SHIFT_OPTIONS, LOCALE_OPTIONS, LOOP_WINDOW_OPTIONS, SettingsForm(), SettingsFormProps (+4 more)
...
Cohesion: 0.09
Nodes (31): LyricsEditor(), LyricsEditorProps, OfflineStatus(), OfflineStatusProps, formatBytes(), formatLimit(), ShareDialog(), ShareDialogProps (+23 more)

### Community 50 - "messages.ts"
Cohesion: 0.05
Nodes (50): AboutContent(), FavoritesClient(), BuildStamp(), HomePageClient(), HomePageClientProps, ShareDialog, FEATURES, PublicLanding() (+42 more)
...
Cohesion: 0.12
Nodes (54): main(), Runtime configuration for the songset constructor., _draft_to_proposal(), LangGraph state schema., DraftItem, JudgeItem, JudgeRanking, ProposalItem (+46 more)

### Community 53 - "SongCard.tsx"
Cohesion: 0.12
Nodes (20): formatDuration(), PublicSongsetItem, ShareData, SharePage(), SongCard(), SongCardProps, escapeCssSelectorValue(), SongListProps (+12 more)

### Community 54 - ".create_songset_with_items"
Cohesion: 0.13
Nodes (10): Generate a new unique item ID. Returns: Unique ID string., Create a Songset from a database row tuple. Args: row: Database row tuple with…, Generate a new unique songset ID. Returns: Unique ID string., Songset, Create a new songset owned by this client's user. Args: name: Display name for…, Get a songset by ID, scoped to the current user. Args: songset_id: The songset…, List songsets owned by this client's user. Args: limit: Maximum number of…, Create a songset and its items atomically in a single transaction. Unlike… (+2 more)
...
Cohesion: 0.22
Nodes (13): addFavoriteSchema, GET(), POST(), loadPage(), FavoritesPage(), HomePage(), getCommunityFavoriteSample(), getDashboardStats() (+5 more)
...
Cohesion: 0.14
Nodes (36): diagnose_render_failures(), _json_default(), list_r2_waste(), list_soft_deletes(), _load_clients(), _load_r2(), _orphan_r2_prefixes(), _print_json() (+28 more)

### Community 66 - "migrate_song_library.py"
Cohesion: 0.16
Nodes (17): clean_chinese_filename(), get_next_song_id(), get_source_audio_path(), get_stems_path(), load_poc_results(), load_scraped_lyrics(), migrate_song(), Any (+9 more)
...
Cohesion: 0.12
Nodes (25): PlayerLyricsPanel(), PlayerLyricsPanelProps, buildLrc(), lrcTimestampToSeconds(), LyricsTimingEditor(), LyricsTimingEditorProps, secondsToLrcTimestamp(), CachedResult (+17 more)

### Community 71 - "schema.ts"
Cohesion: 0.04
Nodes (47): DELETE(), GET(), POST(), DELETE(), GET(), reorderSchema, accounts, accountsRelations (+39 more)
...
Cohesion: 0.07
Nodes (42): DELETE(), GET(), createRenderJobSchema, POST(), SONGSET_MAX_SONGS, VALID_FONT_FAMILIES, DispatchMessage, dispatchToRenderWorker() (+34 more)
...
Cohesion: 0.08
Nodes (12): ComponentEditorScreen, ComponentMetadataTable, DataTable, Resize, Play or pause the song, anchored to the highlighted component. - If playing:…, Component metadata table with edit-guard-aware row navigation., Main interactive Component Metadata editor screen (v4). Provides: - Song…, Pause playback if the position has reached the selected component's end_time.… (+4 more)
...
Cohesion: 0.14
Nodes (16): ShareControllerPage(), loadData(), ControllerPage(), loadData(), SongsetData, clamp(), UsePresentationReceiverOptions, UsePresentationReceiverResult (+8 more)
...
Cohesion: 0.08
Nodes (20): get_existing_catalog(), Load existing catalog if it exists. Returns: CatalogIndex (empty if doesn't…, CatalogIndex, Any, Path, Song catalog management for Stream of Worship. This module handles loading,…, Save catalog index to JSON file. Args: path: Path to save catalog_index.json…, Add a song to the catalog. Args: song: Song to add (+12 more)
...
Cohesion: 0.11
Nodes (12): ComponentEditorApp, PlaybackService, Admin Component Metadata editor Textual application., _fmt_time(), ComponentEditorState, ComponentUndoEntry, Any, Clear both the undo and redo stacks for ``session``. Called from action_save on… (+4 more)
...
Cohesion: 0.16
Nodes (20): circular_pc_distance(), _circular_pc_set_within(), _parse_freeform_range(), _parse_note_to_pc(), Parse a free-form range string like 'A2 to G4' or 'G2-E4'. Returns…, Resolve a user-provided voice description to comfortable tonic PCs. Accepts: -…, Chromatic distance between two pitch classes on the circle., Compute comfortable tonic PCs within ``spread`` semitones of the tessitura. A… (+12 more)
...
### Community 128 - "ForcedAlignerWrapper"
Cohesion: 0.15
...
Cohesion: 0.04
Nodes (40): label(), RenderState, Failed, Fresh, Rendering, Stale, Unrendered, Recording (+32 more)
...
Cohesion: 0.05
Nodes (59): Config, main(), Main migration function., handle_config(), handle_ingest(), handle_migration(), handle_playlist(), launch_tui() (+51 more)
...
### Community 151 - "overrides.test.ts"
Cohesion: 0.24
...
Cohesion: 0.05
Nodes (44): AboutPage(), { GET, POST }, DELETE(), DEFAULTS, GET(), PUT(), VALID_FONT_PRESETS, VALID_FONTS (+36 more)
...
Cohesion: 0.09
Nodes (9): Binding, LRCEditorScreen, DataTable, Path, PlaybackState, Resize, Submitted, Parse a timestamp input like [mm:ss.xx] or mm:ss.xx or seconds. (+1 more)
...
Cohesion: 0.02
Nodes (140): align_lrc_recording(), edit_lrc(), _get_alignment_lyrics_text(), _prompt_choice(), Return lyrics text for forced alignment, preferring existing LRC over nominal…, Submit forced alignment for a single recording., Submit forced alignment for multiple recordings (batch mode, no wait)., Submit a recording for forced LRC alignment using Qwen3ForcedAligner. Uses the… (+132 more)
...
### Community 191 - ".load"
Cohesion: 0.03
Nodes (142): _accept_key(), analyze_recording(), cache_assets(), _colorize_visibility(), delete_recording(), _display_lrc(), _display_truncate(), _drain_input_buffer() (+134 more)
...
Cohesion: 0.12
Nodes (11): CapturedControllerProps, castTransportMock, mockPush, mockReplace, mockRouterInstance, presentationSenderMock, RENDER_JOB_RESPONSE, SHARE_RESPONSE (+3 more)
...
### Community 198 - "AndroidArtifactDownloadScheduler"
Cohesion: 0.25
...
Cohesion: 0.07
Nodes (24): AuthUser, AuthController, Authenticated, AuthSessionManager, AuthState, Error, StateFlow, Restoring (+16 more)
...
### Community 231 - "_is_retryable_poll_error"
Cohesion: 0.67
...
Cohesion: 0.14
Nodes (22): build_r2_client(), download_audio(), estimate_tempo(), main(), Path, R2Client, _cache_age_hours(), main() (+14 more)
...
Cohesion: 0.11
Nodes (19): canDocumentFullscreenSnapshot(), canVideoFullscreenSnapshot(), clamp(), ControllerPlayer(), ControllerPlayerProps, formatTime(), PendingResume, PresentationFallback (+11 more)
...
### Community 411 - "app/utils/__init__.py"
Cohesion: 0.25
...
Cohesion: 0.14
Nodes (16): main(), _bottleneck_lines(), _diversity_metrics(), _diversity_summary(), _song_frequency_table(), _song_overlap_matrix(), _theme_coverage_lines(), RunConfig (+8 more)
...
## Knowledge Gaps
- **1229 isolated node(s):** `Debug`, `Staging`, `Release`, `Unknown`, `Unrendered` (+1224 more)
...
- **Why does `ArtifactSizes` connect `RenderViewModelTest.kt` to `utils.ts`?**
