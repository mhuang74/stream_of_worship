# Graph Report - sow_separate_public_pages_from_app  (2026-09-19)

## Corpus Check
- 868 files · ~732,906 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10154 nodes · 20593 edges · 446 communities (359 shown, 87 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 879 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5abc73e8`
...
- [token]/play/controller/page.tsx
- Header.tsx
- share/route.test.ts
- upload.py
...
## Communities (446 total, 87 thin omitted)
...
Cohesion: 0.02
Nodes (73): _print_dry_run(), Print dry run information showing what would be processed. Args: db_client:…, DatabaseClient, Connection, Recording, Song, Context manager for database transactions. Yields: psycopg connection with an…, Get a recording by its analysis or LRC job ID. Args: job_id: The job ID.… (+65 more)

### Community 4 - "RenderStatusBadge.tsx"
Cohesion: 0.09
Nodes (33): formatDuration(), PublicSongsetItem, ShareData, SharePage(), DashboardSongsetCard(), StatCard(), StatCardProps, OfflineStatusProps (+25 more)
...
Cohesion: 0.03
Nodes (52): build_correction_prompt(), format_transcript_text(), main(), command, Path, Generate LRC from YouTube transcript corrected by LLM. Downloads YouTube…, Format transcript snippets as timestamped text for LLM prompt. Args:…, Build LLM prompt for lyrics correction. Args: transcript_text: Formatted… (+44 more)
...
Cohesion: 0.04
Nodes (65): datetime, Connection health checker for sow-app. Re-exports the shared…, construct_songset(), _dedupe_songset_name(), _format_duration(), _pick_song_interactive(), Console, Recording (+57 more)

### Community 16 - "SongsetEditor.tsx"
Cohesion: 0.04
Nodes (61): ShareDialog, ApiResponse, ApiSongset, ApiSongsetItem, BrowseSheet, RenderJobR2Keys, ShareDialog, SongsetEditorClient() (+53 more)
...
Cohesion: 0.03
Nodes (51): ForgotPasswordPage(), handleSubmit(), validate(), ResetPasswordPage(), PreviousRenderJobData, RENDER_JOB_POLL_INTERVAL_MS, RenderSubmitted(), AccountSettings() (+43 more)
...
Cohesion: 0.12
Nodes (16): AuthApi, AuthSession, BetterAuthData, BetterAuthEnvelope, BetterAuthError, EmailPasswordRequest, Response, ResponseBody (+8 more)

### Community 25 - "dispatcher.ts"
Cohesion: 0.14
...
### Community 27 - "section_segmenter.py"
Cohesion: 0.07
Nodes (52): AbstractEventLoop, _normalize_line(), Snap a timestamp to the nearest beat. Args: time_seconds: Timestamp in seconds.…, Normalize a lyric line for repetition comparison. Strips, lowercases, removes…, _snap_to_beat(), _acquire_llm_slot(), call_llm_with_retry(), _enforce_llm_min_interval() (+44 more)
...
Cohesion: 0.06
Nodes (47): AudioPlayerBar(), LyricsErrorFallback(), GlobalAudioPlayer(), GlobalAudioPlayerProps, PlaybarRouteGuard(), ContainingSongset, LocateSongsetsPopover(), Popover() (+39 more)
...
Cohesion: 0.05
Nodes (34): canDocumentFullscreenSnapshot(), canVideoFullscreenSnapshot(), clamp(), ControllerPlayer(), ControllerPlayerBaseProps, ControllerPlayerProps, formatTime(), PendingResume (+26 more)

### Community 43 - "useLocaleContext"
Cohesion: 0.06
Nodes (69): LoginPage(), handleSubmit(), validate(), RegisterPage(), handleSubmit(), validate(), ResetPasswordForm(), handleSubmit() (+61 more)

### Community 44 - "app/main.py"
Cohesion: 0.06
Nodes (36): Main entry point for the Song Transition Preview App., Transition data models., Format for display in history list., Format generated time as HH:MM:SS., Return status indicator., Represents a generated transition with metadata and parameters., TransitionRecord, Generation screen for song transition preview app. (+28 more)
...
### Community 49 - "cn"
Cohesion: 0.05
Nodes (83): formatTime(), LyricsReviewSheet(), LyricsReviewSheetProps, TABS, TabType, ResultMode, SemanticSearchProps, SemanticSearchResult (+75 more)

### Community 50 - "album-filter.ts"
Cohesion: 0.37
Nodes (10): AlbumMultiSelect(), albumFilterKey(), compareNullsLast(), extractSeriesPrefix(), extractTrailingNumber(), formatAlbumLabel(), formatAlbumOptionLabel(), normalizeAlbumFilters() (+2 more)
...
Cohesion: 0.05
Nodes (37): Recording, Song, SongsPage, SongsetDetail, SongsetItem, SongsetItemRecording, SongsetItemSong, SongsetsPage (+29 more)

### Community 54 - "PlaybackService"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (41): dependencies, lucide-react, next, react, react-dom, devDependencies, class-variance-authority, clsx (+33 more)
...
Cohesion: 0.11
Nodes (20): UserSettings, settingsValidationError(), CoroutineScope, StateFlow, ViewModel, SettingsUiState, SettingsViewModel, statusMessage() (+12 more)

### Community 63 - ".__init__"
Cohesion: 0.09
Nodes (14): CurrentLyricDisplay, PlaybackBar, PreviewBanner, ComposeResult, Path, PlaybackService, PlaybackState, R2Client (+6 more)
...
### Community 66 - "editor/screen.py"
Cohesion: 0.08
Nodes (43): Lyrics Panel widget for the Component Metadata editor (v6). Right panel (lyrics…, Textual application for the admin LRC editor. Launches the interactive LRC…, Main editor screen for the admin LRC editor. Provides the interactive LRC…, Editor state model for the admin LRC editor. Holds all mutable editing session…, _check_all_zero_draft(), _check_duplicate_timestamps(), _check_duration_sanity(), _check_monotonic_timestamps() (+35 more)
...
Cohesion: 0.04
Nodes (48): DELETE(), GET(), POST(), DELETE(), GET(), POST(), reorderSchema, accounts (+40 more)
...
Cohesion: 0.07
Nodes (35): FavoritesClient(), FavoritesClientProps, HomePageClient(), HomePageClientProps, DashboardSongset, OfflineIndicator(), OfflineIndicatorProps, useSemanticSearch() (+27 more)
...
Cohesion: 0.12
Nodes (27): DELETE(), GET(), createRenderJobSchema, POST(), renderJobs, VALID_FONT_FAMILIES, cancelRenderJob(), completeRenderJob() (+19 more)
...
Cohesion: 0.09
Nodes (10): ComponentEditorScreen, Any, Path, Resize, Cycle: hidden → lyrics → details → hidden., Update CSS classes and widget visibility based on _right_panel_mode., Replace session components with refreshed SongComponent objects reflecting the…, Main interactive Component Metadata editor screen (v4). Provides: - Song… (+2 more)
...
Cohesion: 0.06
Nodes (33): @aws-sdk/client-s3, @aws-sdk/s3-request-presigner, @base-ui/react, dependencies, @aws-sdk/client-s3, @aws-sdk/s3-request-presigner, @base-ui/react, @dnd-kit/core (+25 more)

### Community 98 - "component_editor/screen.py"
Cohesion: 0.04
Nodes (53): Launch a Textual TUI to view / review / compare / edit component metadata.…, review_components(), Textual app for the admin Component Metadata editor., identify_editor_role(), Constants for the Component Metadata editor TUI (v6). v6 changes from v5: - New…, Map a DB SongComponent to its editor-level role key, or None if not essential.…, Component Detail Panel widget for the Component Metadata editor (v6). Right…, fetch_lrc_for_song() (+45 more)
...
Cohesion: 0.08
Nodes (18): LyricsPanel, Resize, ScrollView, Strip, Text, Build the Rich Text representation of the lyrics content. ``component_range``…, Render Rich Text into Strip objects at the current content width., Right panel (lyrics mode) showing timestamped LRC lyrics for the current song.… (+10 more)
...
### Community 108 - "chapters.ts"
Cohesion: 0.07
Nodes (20): R2Client, AssetFetcher, AssetFetcherOptions, AudioSegmentInfo, buildChaptersFromSegments(), ChapterGenerationOptions, ChapterLine, ChaptersManifest (+12 more)
...
Cohesion: 0.10
Nodes (33): Activity, android, Composable, Modifier, SowEmptyState(), SowErrorState(), SowLoadingState(), StatePanel() (+25 more)
...
### Community 125 - "stem_separation.py"
Cohesion: 0.07
...
### Community 130 - "songs.ts"
Cohesion: 0.08
Nodes (49): loadPage(), FavoritesPage(), RootLayout(), HomePage(), db, sql, songs, userFavorites (+41 more)
...
### Community 138 - "usePresentation.ts"
Cohesion: 0.18
...
### Community 147 - "PlayerController"
Cohesion: 0.07
...
### Community 149 - "TransitionBuilderApp"
Cohesion: 0.12
...
### Community 150 - "ComponentAutosaveState"
Cohesion: 0.35
...
Cohesion: 0.02
Nodes (171): Future, Lock, adaptive_interval(), _advance_song(), _aggregate_recording_theme(), _apply_manifest_writeback(), _backfill_lyrics_batch(), _backfill_lyrics_for_song() (+163 more)
...
### Community 155 - "editor/autosave.py"
Cohesion: 0.20
...
Cohesion: 0.12
Nodes (41): event(), Trace event helpers for graph nodes., Runtime configuration for the songset constructor., build_graph(), Build the songset constructor graph., choose_checkpointer(), Checkpointer selection — always InMemorySaver for v3., build_chat_model() (+33 more)

### Community 164 - "LandingPage.tsx"
Cohesion: 0.17
Nodes (13): AboutPage(), DocsPage(), FEATURES, LandingPage(), STEPS, SiteFooter(), SiteHeader(), ButtonVariantProps (+5 more)
...
### Community 166 - "i18n/messages.ts"
Cohesion: 0.13
Nodes (16): audioBundle, browseBundle, bundle(), BundleKeys, controlBundle, core, favoritesBundle, LOCALES (+8 more)
...
### Community 179 - "settings/page.tsx"
Cohesion: 0.07
...
Cohesion: 0.07
Nodes (35): Bundle, ComponentActivity, Modifier, SowApp(), SowNavigationBarItem(), SowShell(), Modifier, rememberSongsetsDependencies() (+27 more)

### Community 182 - "PlayerViewModel"
Cohesion: 0.10
Nodes (19): FullscreenPlaybackOverlays(), Modifier, PlaybackErrorContent(), PlaybackErrorPanel(), SoftwareDecoderWarningBanner(), isExpired(), CoroutineScope, OfflineArtifactKind (+11 more)
...
Cohesion: 0.04
Nodes (88): _is_retryable_poll_error(), Exception, Whether a polling failure should be retried once (transient)., _build_fresh_editor_state(), feedback_list(), feedback_resolve(), feedback_unresolve(), _get_alignment_lyrics_text() (+80 more)
...
### Community 187 - "._last_modified_to_str"
Cohesion: 0.11
...
### Community 190 - "forced_alignment.py"
Cohesion: 0.20
...
### Community 192 - "[token]/play/controller/page.tsx"
Cohesion: 0.30
Nodes (3): ShareControllerPage(), CastCommandTarget, dispatchCast()

### Community 193 - "Header.tsx"
Cohesion: 0.05
Nodes (40): geistMono, geistSans, metadata, BottomNav(), Header(), LABEL_KEY, LanguageSwitcher(), SemanticSearch() (+32 more)
...
### Community 198 - "._guard_active_edit"
Cohesion: 0.18
...
### Community 200 - "._selected_editor_role"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (31): Path, Main TUI application for Stream of Worship. This is the entry point for the…, Run the transition builder app with old-style config loading., Initialize the application. Args: config_path: Path to config.json, run_transition_builder(), ErrorLogger, get_session_logger(), init_error_logger() (+23 more)
...
### Community 227 - "SowPlaybackService"
Cohesion: 0.33
...
### Community 236 - "settings/route.ts"
Cohesion: 0.07
Nodes (25): DEFAULTS, GET(), PUT(), VALID_FONT_PRESETS, VALID_FONTS, VALID_RESOLUTIONS, VALID_TEMPLATES, userSettings (+17 more)
...
### Community 256 - "sow_analysis/logging_config.py"
Cohesion: 0.21
...
Cohesion: 0.10
Nodes (25): _build_report(), _format_duration(), main(), _pool_overview(), _proposal_section(), Build the full proposal_report.md content., Generate the run summary section., Generate the pool overview section. (+17 more)
...
### Community 267 - "OfflinePlaybackState"
Cohesion: 0.33
...
### Community 275 - "[id]/play/controller/page.tsx"
Cohesion: 0.04
Nodes (87): OfflineClient(), OfflineRow, loadData(), AuthRedirectError, ChapterRecordingHashes, ControllerMedia, ControllerPage(), loadChapters() (+79 more)

### Community 276 - "SongsetItemWithDetails"
Cohesion: 0.20
...
### Community 277 - "Development Roadmap"
Cohesion: 0.17
...
### Community 324 - "recover_visibility.py"
Cohesion: 0.04
Nodes (58): _batch_lookup_analysis(), _batch_lookup_r2(), _build_candidate_query(), CandidateSignals, _compute_verdict(), _get_db_client(), _lookup_analysis_job(), _lookup_rlc_identity() (+50 more)

### Community 329 - "sow_lab_app/app.py"
Cohesion: 0.02
Nodes (135): format_timestamp(), Format seconds as [mm:ss.xx] timestamp. Args: seconds: Time in seconds Returns:…, Main TUI application for Stream of Worship User App. Textual-based application…, AppConfig, ensure_app_config_exists(), get_app_config_dir(), get_app_config_path(), get_cache_dir() (+127 more)
...
Cohesion: 0.05
Nodes (45): Set the current job_id in the context. Args: job_id: Job ID to set, or None to…, set_job_id(), Job, JobResult, Result data for a completed job., Represents a job in the queue., Analysis workers for processing jobs., LRCWorkerError (+37 more)
...
### Community 401 - "ComponentEditorApp"
Cohesion: 0.40
...
### Community 421 - ".load"
Cohesion: 0.03
Nodes (112): _accept_key(), analyze_recording(), cache_assets(), _colorize_visibility(), components_recording(), delete_recording(), _display_truncate(), _drain_input_buffer() (+104 more)
...
Cohesion: 0.09
Nodes (23): 1. Analysis Service (`ops/analysis-service/`), 2. Render Worker (`delivery/render-worker/`), Agent Skills, Alternative: All-In-One Deep Learning Analysis, Analysis-Specific Issues, Backend Services, Components Status, Contributing (+15 more)
...
## Knowledge Gaps
- **1372 isolated node(s):** `Debug`, `Staging`, `Release`, `Unknown`, `Unrendered` (+1367 more)
