# Graph Report - stream_of_worship  (2026-09-18)

## Corpus Check
- 855 files · ~732,229 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10057 nodes · 20473 edges · 421 communities (343 shown, 78 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 879 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `64492d00`
...
## Communities (421 total, 78 thin omitted)

### Community 0 - "SongsetClient"
Cohesion: 0.04
Nodes (40): Get a songset with resolved items using batch queries (Fix 10). Steps: 1. Fetch…, Create a SongsetItem from a database row tuple. Args: row: Database row tuple…, Generate a new unique item ID. Returns: Unique ID string., Create a Songset from a database row tuple. Args: row: Database row tuple with…, Generate a new unique songset ID. Returns: Unique ID string., NotOwnerError, Any, Connection (+32 more)
...
### Community 4 - "ConnectionProvider"
Cohesion: 0.07
Nodes (30): build_correction_prompt(), format_transcript_text(), main(), command, Path, Generate LRC from YouTube transcript corrected by LLM. Downloads YouTube…, Format transcript snippets as timestamped text for LLM prompt. Args:…, Build LLM prompt for lyrics correction. Args: transcript_text: Formatted… (+22 more)
...
Cohesion: 0.07
Nodes (32): _classify_posture_heuristic(), _extract_lyrics_for_component(), _has_religious_pronoun(), _is_essential(), _lyric_hash(), LLM-based theme and vocal posture classification for song components., Extract lyric lines within a component's time range from LRC content. Parses…, Normalized content hash for lyric deduplication. Lowercases, collapses… (+24 more)
...
### Community 11 - "songset.py"
Cohesion: 0.03
Nodes (73): LoginScreen, AppState, ComposeResult, RowSelected, Screen, Login (pick-a-user) screen. Shows the list of users from the ``"user"`` table…, Pick-a-user screen, shown at TUI startup., Initialize the login screen. Args: state: Application state. user_client:… (+65 more)
...
### Community 15 - "cn"
Cohesion: 0.05
Nodes (66): ShareDialog, ShareDialog, ShareDialog, formatBytes(), formatLimit(), ShareDialog(), ShareDialogProps, ShareInfo (+58 more)

### Community 16 - "SongsetEditorClient.tsx"
Cohesion: 0.04
Nodes (65): PlayPage(), loadSongset(), offerOfflineEntry(), RenderJobData, SongsetData, SongsetItem, SongsetNotFoundError, ApiResponse (+57 more)
...
Cohesion: 0.05
Nodes (51): Activity, SowTheme(), findActivity(), Media3PlayerController, FullscreenPlaybackOverlays(), Modifier, OfflinePlaybackBanner(), PlaybackErrorContent() (+43 more)
...
Cohesion: 0.03
Nodes (65): ResetPasswordPage(), fetchSettings(), SettingsPage(), loadSettings(), PreviousRenderJobData, RENDER_JOB_POLL_INTERVAL_MS, RenderSubmitted(), TransitionSheet() (+57 more)

### Community 23 - "r2/client.ts"
Cohesion: 0.05
Nodes (34): GET(), LyricsResponse, ALLOWED_FILES, CONTENT_TYPES, FILE_TYPES, GET(), GET(), SignedUrlParams (+26 more)
...
Cohesion: 0.13
Nodes (31): Snap a timestamp to the nearest beat. Args: time_seconds: Timestamp in seconds.…, Snap a timestamp to the nearest downbeat. Args: time_seconds: Timestamp in…, _snap_to_beat(), _snap_to_downbeat(), _build_client(), _build_segmentation_prompt(), _corrective_segmentation_call(), _load_few_shot_examples() (+23 more)
...
### Community 34 - "SongWithRecording"
Cohesion: 0.09
...
Cohesion: 0.12
Nodes (21): invalidateArtifactCache(), deleteControllerDocument(), getOfflineRecord(), isOfflineIndexAvailable(), listOfflineRecords(), OFFLINE_INDEX_DB_NAME, OFFLINE_INDEX_STORE_NAME, OfflineSongsetRecord (+13 more)
...
Cohesion: 0.06
Nodes (68): ForgotPasswordPage(), handleSubmit(), validate(), LoginPage(), handleSubmit(), validate(), RegisterPage(), handleSubmit() (+60 more)
...
Cohesion: 0.10
Nodes (20): SongsetItemRecording, SongsetsPage, RenderScreenTest, detail(), FakeRenderRepository, FakeRenderSongsetsRepository, item(), job() (+12 more)
...
### Community 49 - "_is_retryable_poll_error"
Cohesion: 0.67
...
Cohesion: 0.05
Nodes (77): FavoritesClient(), FavoritesClientProps, HomePageClient(), HomePageClientProps, DashboardSongset, DashboardSongsetCard(), DashboardSongsetCardProps, ResultMode (+69 more)
...
Cohesion: 0.04
Nodes (44): label(), RenderState, Failed, Fresh, Rendering, Stale, Unrendered, Recording (+36 more)
...
Cohesion: 0.08
Nodes (58): GET(), GET(), AlbumFilterSchema, POST(), RequestSchema, FavoriteContext, loadFavoriteContext(), fullTextSearchSongs() (+50 more)
...
### Community 60 - "call_llm_with_retry"
Cohesion: 0.13
...
### Community 65 - "ComponentInstance"
Cohesion: 0.13
Nodes (15): Return a truncated single-line preview of lyric lines for logging. Joins lines…, Classifies song components using LLM theme and vocal posture detection. Reuses…, Classify one component with start/completed/failed progress logging., Classify a single component's theme and vocal posture. The heuristic pre-pass…, Classify via LLM API call, with heuristic cross-check. Uses the shared…, Synchronous OpenAI classification call, run in an executor. Returns the parsed…, Populate component fields from a parsed LLM response and cross-check. LLM-…, Log diagnostic details for an LLM API call at DEBUG level. Logs: model, token… (+7 more)

### Community 66 - "services/lrc_parser.py"
Cohesion: 0.09
Nodes (39): LRCLine, Editor state model for the admin LRC editor. Holds all mutable editing session…, _check_all_zero_draft(), _check_duplicate_timestamps(), _check_duration_sanity(), _check_monotonic_timestamps(), _check_preservation(), _generate_diff() (+31 more)
...
### Community 74 - "RenderStatusBadge.tsx"
Cohesion: 0.09
Nodes (33): RenderPageClient(), OfflineStatus(), OfflineStatusProps, FavoriteButton(), FavoriteButtonProps, ADR-0002, RenderStatusBadgeProps, STATE_CONFIG (+25 more)

### Community 75 - "lrc.py"
Cohesion: 0.05
Nodes (64): model_validator, LrcOptions, field_validator, Options for LRC generation jobs., Reject legacy field names that have been renamed., LLMConfigError, Exception, Base exception for worker errors. (+56 more)
...
Cohesion: 0.08
Nodes (38): _assign_roles_by_energy(), compute_component_features(), _deserialize_components(), _detect_downbeats_madmom(), _detect_key_from_precomputed_chroma(), _detect_phrases_via_onset(), extract_components(), get_or_detect_beat_grid() (+30 more)
...
Cohesion: 0.10
Nodes (17): buildShareTextIntent(), buildViewArtifactIntent(), enqueueArtifactDownload(), Context, Intent, RenderArtifactKind, Audio, Video (+9 more)
...
Cohesion: 0.05
Nodes (39): Launch a Textual TUI to view / review / compare / edit component metadata.…, review_components(), ComponentEditorApp, PlaybackService, Textual app for the admin Component Metadata editor., Admin Component Metadata editor Textual application., identify_editor_role(), Constants for the Component Metadata editor TUI (v6). v6 changes from v5: - New… (+31 more)
...
Cohesion: 0.05
Nodes (20): DefaultRenderersFactory, MediaPlayerFacade, AndroidWakeLockHandle, PlaybackWakeLock, WakeLockHandle, Intent, SowPlaybackService, createVideoRenderersFactory() (+12 more)
...
### Community 107 - "artifact-cache-sw-parity.test.ts"
Cohesion: 0.16
Nodes (11): ARTIFACT_FILE_TYPE, artifactCacheKeyForUrl(), artifactHandler(), RFC-9110, parseRangeHeader(), rangeResponseFrom(), ARTIFACT_CACHE_NAME, SOW_PAGES_CACHE_NAME (+3 more)
...
Cohesion: 0.12
Nodes (25): addFavoriteSchema, GET(), POST(), loadPage(), FavoritesPage(), HomePage(), sql, CommunityFavoriteSong (+17 more)
...
### Community 138 - "[id]/play/controller/page.tsx"
Cohesion: 0.14
Nodes (17): ShareControllerPage(), loadData(), AuthRedirectError, ChapterRecordingHashes, ControllerMedia, ControllerPage(), loadChapters(), loadData() (+9 more)
...
### Community 147 - "TransitionRecord"
Cohesion: 0.13
...
### Community 164 - "signed-url/route.test.ts"
Cohesion: 0.17
...
### Community 179 - "useLocaleContext"
Cohesion: 0.05
Nodes (43): geistMono, geistSans, metadata, RootLayout(), ResetPasswordForm(), handleSubmit(), validate(), DEFAULT_SETTINGS (+35 more)
...
Cohesion: 0.02
Nodes (196): Future, Lock, _accept_key(), adaptive_interval(), _advance_song(), _aggregate_recording_theme(), analyze_recording(), _apply_manifest_writeback() (+188 more)
...
Cohesion: 0.06
Nodes (37): AboutContent(), AboutPage(), BuildStamp(), FEATURES, PublicLanding(), STEPS, StatCard(), StatCardProps (+29 more)
...
### Community 200 - "SongsetItemWithDetails"
Cohesion: 0.25
...
### Community 202 - "Web App (`sow-webapp`)"
Cohesion: 0.25
...
Cohesion: 0.19
Nodes (8): cacheControllerDocument(), controllerDocumentPath(), isLoginPage(), preload(), PreloadTarget, preloadTargets(), WARM_TIMEOUT_MS, warmDocument()

### Community 205 - "usePresentationSender.test.ts"
Cohesion: 0.33
...
### Community 217 - "sow_analysis/main.py"
Cohesion: 0.04
...
Cohesion: 0.10
Nodes (21): Admin CLI (`sow-admin`), Audio Issues, Commands, Common Commands, Common Usage Workflow, Configuration, Configuration, Configuration (+13 more)

### Community 220 - "POC Analysis Setup"
Cohesion: 0.33
...
Cohesion: 0.11
Nodes (9): ComponentEditorScreen, Resize, Cycle: hidden → lyrics → details → hidden., Update CSS classes and widget visibility based on _right_panel_mode., Replace session components with refreshed SongComponent objects reflecting the…, Main interactive Component Metadata editor screen (v4). Provides: - Song…, v6. Re-renders the LyricsPanel for the current song. Skips if right panel is…, Return the field key for the current cursor column (retained for autosave… (+1 more)
...
Cohesion: 0.05
Nodes (47): { GET, POST }, DELETE(), DELETE(), GET(), DEFAULTS, GET(), PUT(), VALID_FONT_PRESETS (+39 more)
...
Cohesion: 0.09
Nodes (29): LyricJumpListProps, artifactCacheKey(), ArtifactCacheStatus, CacheableArtifacts, cacheArtifacts(), getArtifactCacheStatus(), getStorageBudget(), HARD_LIMIT_BYTES (+21 more)
...
Cohesion: 0.02
Nodes (129): _build_fresh_editor_state(), feedback_list(), feedback_resolve(), feedback_unresolve(), _load_connection_provider(), lyrics_generate(), lyrics_upload(), lyrics_view() (+121 more)

### Community 329 - ".to_dict"
Cohesion: 0.40
...
Cohesion: 0.02
Nodes (108): datetime, format_timestamp(), Format seconds as [mm:ss.xx] timestamp. Args: seconds: Time in seconds Returns:…, Main TUI application for Stream of Worship User App. Textual-based application…, AppConfig, ensure_app_config_exists(), get_app_config_dir(), get_app_config_path() (+100 more)

### Community 387 - "JobQueue"
Cohesion: 0.05
Nodes (42): Set the current job_id in the context. Args: job_id: Job ID to set, or None to…, set_job_id(), Job, Represents a job in the queue., has_cached_llm_fields(), Check whether components already carry LLM classification results. Returns True…, _compute_lrc_cache_key(), JobQueue (+34 more)

### Community 398 - "AuthValidation"
Cohesion: 0.46
Nodes (3): AuthValidation, LoginValidationErrors, RegisterValidationErrors

### Community 399 - "maintenance.py"
Cohesion: 0.03
...
### Community 403 - ".on_input_submitted"
Cohesion: 0.15
Nodes (5): Binding, DataTable, Submitted, Parse a timestamp input like [mm:ss.xx] or mm:ss.xx or seconds., ValidationResult
...
### Community 421 - ".load"
Cohesion: 0.04
Nodes (74): probe(), probe_batch(), Probe audio duration via ffprobe and update the recording in the database.…, Batch probe audio durations for recordings missing duration_seconds. Downloads…, _display_stats(), _get_db_client(), init_db(), _mask_url() (+66 more)
...
Cohesion: 0.04
Nodes (30): DirectPlayerFacade, AnalyticsListener, Player, Player, isDecoderPlaybackError(), isSoftwareVideoDecoder(), Player, StateFlow (+22 more)
...
## Knowledge Gaps
- **1321 isolated node(s):** `Debug`, `Staging`, `Release`, `Unknown`, `Unrendered` (+1316 more)
...
- **Why does `ArtifactSizes` connect `ArtifactDownloadRequest` to `cn`?**
