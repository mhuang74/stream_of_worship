# Graph Report - stream_of_worship  (2026-09-19)

## Corpus Check
- 872 files · ~735,048 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10196 nodes · 20651 edges · 462 communities (361 shown, 101 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 879 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a28aaf55`
...
## Communities (462 total, 101 thin omitted)
...
Cohesion: 0.02
Nodes (79): _print_dry_run(), Print dry run information showing what would be processed. Args: db_client:…, DatabaseClient, Connection, Recording, Song, Context manager for database transactions. Yields: psycopg connection with an…, Get a recording by its analysis or LRC job ID. Args: job_id: The job ID.… (+71 more)

### Community 4 - "RenderStatusBadge.tsx"
Cohesion: 0.13
Nodes (22): OfflineStatusProps, FavoriteButton(), FavoriteButtonProps, ADR-0002, RenderStatusBadge(), RenderStatusBadgeProps, STATE_CONFIG, Tooltip() (+14 more)
...
Cohesion: 0.10
Nodes (28): _review_song_fields(), build_lyrics_payload(), build_song_diff(), build_song_from_review(), compute_song_id(), _normalize_lyrics_raw(), normalize_reviewed_data(), parse_review_document() (+20 more)
...
Cohesion: 0.08
Nodes (26): add_user(), delete_user(), _get_user_client(), list_users(), _load_config(), _print_cascade_preview(), command, Path (+18 more)
...
Cohesion: 0.02
Nodes (121): datetime, format_timestamp(), Format seconds as [mm:ss.xx] timestamp. Args: seconds: Time in seconds Returns:…, AppConfig, ensure_app_config_exists(), get_app_config_dir(), get_app_config_path(), get_cache_dir() (+113 more)

### Community 16 - "SongsetEditor.tsx"
Cohesion: 0.05
Nodes (58): ShareDialog, ApiResponse, ApiSongset, ApiSongsetItem, BrowseSheet, RenderJobR2Keys, ShareDialog, SongsetEditorClientProps (+50 more)
...
Cohesion: 0.04
Nodes (83): AnalyzeJobRequest, AnalyzeOptions, ComponentAnalysisJobRequest, ComponentAnalysisOptions, ComponentResult, EmbeddingJobRequest, EmbeddingJobResult, FastAnalyzeJobRequest (+75 more)
...
Cohesion: 0.03
Nodes (54): ForgotPasswordPage(), handleSubmit(), validate(), ResetPasswordPage(), DEFAULT_SETTINGS, fetchSettings(), SettingsPage(), loadSettings() (+46 more)

### Community 23 - "index.ts"
Cohesion: 0.04
Nodes (56): DELETE(), GET(), LyricsFeedbackResponse, PUT(), GET(), LyricsResponse, ALLOWED_FILES, CONTENT_TYPES (+48 more)
...
Cohesion: 0.10
Nodes (14): ControllerPlayerBaseProps, CastTransportResult, CapturedControllerProps, castTransportMock, { mockGetOfflineRecord }, mockPush, mockReplace, mockRouterInstance (+6 more)
...
Cohesion: 0.03
Nodes (139): AbstractEventLoop, _extract_lyrics_for_component(), _is_essential(), _lyric_hash(), LLM-based theme and vocal posture classification for song components., Extract lyric lines within a component's time range from LRC content. Parses…, Normalized content hash for lyric deduplication. Lowercases, collapses…, Return True if the component's role is transition-essential. Mirrors… (+131 more)
...
Cohesion: 0.05
Nodes (48): geistMono, geistSans, metadata, AudioPlayerBar(), GlobalAudioPlayer(), GlobalAudioPlayerProps, PlaybarRouteGuard(), TransitionSheet() (+40 more)
...
Cohesion: 0.08
Nodes (49): extract_video_id(), parse_lrc_response(), Parse LLM response and extract valid LRC lines. Args: response: LLM response…, Extract YouTube video ID from URL. Args: youtube_url: YouTube URL Returns:…, judge_official_lines(), JudgeParseError, load_fixture(), load_model_ids() (+41 more)

### Community 33 - "youtube_transcript.py"
Cohesion: 0.04
Nodes (56): LLMConfigError, Exception, Base exception for worker errors., Raised when LLM configuration is missing or invalid., WorkerError, _is_llm_rate_limited_error(), _is_llm_retryable_error(), Detect whether an exception is a transient 5xx error worth retrying. Short-… (+48 more)

### Community 34 - "youtube.py"
Cohesion: 0.13
Nodes (20): _cleanup_transcript_line(), derive_song_defaults(), _extract_chinese_title_from_youtube(), extract_video_id(), extract_video_metadata(), _fetch_transcript_draft(), fetch_transcript_lines(), _find_best_transcript() (+12 more)
...
Cohesion: 0.14
Nodes (18): bootstrap_admin_src(), bootstrap_analysis_src(), EvalError, FixtureError, now_run_id(), Exception, Resolve candidate model IDs: ``--models`` spec wins; else…, Fatal skill error with a user-facing message. (+10 more)
...
Cohesion: 0.08
Nodes (49): LoginPage(), handleSubmit(), validate(), RegisterPage(), handleSubmit(), validate(), ResetPasswordForm(), handleSubmit() (+41 more)
...
### Community 49 - "cn"
Cohesion: 0.05
Nodes (68): LyricsErrorFallback(), ContainingSongset, LocateSongsetsPopover(), formatDurationSafe(), isDifferent(), RenderForm(), RenderFormProps, TITLE_CARD_DURATIONS (+60 more)

### Community 50 - "BrowseSheet.tsx"
Cohesion: 0.07
Nodes (52): ResultMode, SemanticSearch(), SemanticSearchProps, SemanticSearchResult, useSemanticSearch(), UseSemanticSearchOptions, AlbumMultiSelect(), AlbumMultiSelectProps (+44 more)
...
Cohesion: 0.04
Nodes (39): Recording, Song, SongsPage, SongsetDetail, SongsetItem, SongsetItemRecording, SongsetItemSong, SongsetsPage (+31 more)
...
Cohesion: 0.07
Nodes (28): clear_autosave(), ComponentAutosaveState, get_autosave_path(), load_autosave(), Path, Autosave recovery for the Component Metadata editor. One file per song at…, State captured in the autosave recovery file., save_autosave() (+20 more)
...
Cohesion: 0.07
Nodes (68): GET(), GET(), AlbumFilterSchema, POST(), RequestSchema, sql, FavoriteContext, loadFavoriteContext() (+60 more)
...
Cohesion: 0.05
Nodes (61): _build_fresh_editor_state(), lyrics_edit(), Recording, Song, Build a fresh EditorState from transcribed content or catalog lyrics., Interactively edit LRC timestamps for a song recording. Downloads/caches the…, Lyrics Panel widget for the Component Metadata editor (v6). Right panel (lyrics…, autosave_exists() (+53 more)
...
Cohesion: 0.04
Nodes (52): DELETE(), GET(), POST(), DELETE(), GET(), POST(), reorderSchema, accounts (+44 more)
...
Cohesion: 0.07
Nodes (31): FavoritesClient(), FavoritesClientProps, HomePageClient(), HomePageClientProps, DashboardSongset, OfflineIndicator(), OfflineIndicatorProps, buttonVariants (+23 more)

### Community 76 - "job-manager.ts"
Cohesion: 0.07
Nodes (42): DELETE(), GET(), createRenderJobSchema, POST(), renderJobs, SONGSET_MAX_SONGS, DispatchMessage, dispatchToRenderWorker() (+34 more)
...
Cohesion: 0.08
Nodes (16): CellHighlighted, CellSelected, ComponentEditorScreen, Any, Resize, RowHighlighted, Submitted, Cycle: hidden → lyrics → details → hidden. (+8 more)
...
Cohesion: 0.04
Nodes (37): build_correction_prompt(), format_transcript_text(), main(), command, Path, Generate LRC from YouTube transcript corrected by LLM. Downloads YouTube…, Format transcript snippets as timestamped text for LLM prompt. Args:…, Build LLM prompt for lyrics correction. Args: transcript_text: Formatted… (+29 more)
...
Cohesion: 0.06
Nodes (33): @aws-sdk/client-s3, @aws-sdk/s3-request-presigner, @base-ui/react, better-auth, dependencies, @aws-sdk/client-s3, @aws-sdk/s3-request-presigner, @base-ui/react (+25 more)

### Community 98 - "ComponentEditorState"
Cohesion: 0.07
Nodes (25): ComponentEditorApp, PlaybackService, Textual app for the admin Component Metadata editor., Admin Component Metadata editor Textual application., Component Detail Panel widget for the Component Metadata editor (v6). Right…, fetch_lrc_for_song(), LRCFetch, prefetch_all_lrc() (+17 more)
...
Cohesion: 0.13
Nodes (30): delete_song(), _delete_song_single(), _delete_songs_batch(), edit_song(), insert_song(), _print_duplicate_guidance(), _prompt_confirmation(), command (+22 more)
...
Cohesion: 0.12
Nodes (22): addFavoriteSchema, GET(), POST(), DELETE(), loadPage(), FavoritesPage(), RootLayout(), HomePage() (+14 more)
...
Cohesion: 0.15
Nodes (15): ShareControllerPage(), loadData(), clamp(), UsePresentationReceiverOptions, UsePresentationReceiverResult, usePresentationSender(), UsePresentationSenderOptions, UsePresentationSenderResult (+7 more)
...
Cohesion: 0.03
Nodes (149): Future, Lock, adaptive_interval(), _advance_song(), _aggregate_recording_theme(), _apply_manifest_writeback(), batch(), _cancel_all_jobs() (+141 more)
...
Cohesion: 0.12
Nodes (18): RenderPageClientProps, RenderFormData, BPM_BAND_KEYS, BPM_BANDS, FONT_SIZES, FontFamilyValue, normalizeFontFamily(), PITCH_CLASSES (+10 more)

### Community 179 - "SongsetListSkeleton.tsx"
Cohesion: 0.25
Nodes (3): SongsetEditorSkeleton(), SongsetListSkeleton(), Skeleton()
...
Cohesion: 0.03
Nodes (141): _accept_key(), analyze_recording(), _backfill_lyrics_batch(), _backfill_lyrics_for_song(), cache_assets(), _colorize_visibility(), components_recording(), delete_recording() (+133 more)
...
Cohesion: 0.03
Nodes (63): Database client for sow-admin. Provides PostgreSQL database operations for song…, Main editor screen for the admin LRC editor. Provides the interactive LRC…, check_active_lrc_job(), check_transcribed_changed(), generate_timestamped_filename(), Path, R2Client, Upload and save flow for the admin LRC editor. Handles local draft save, R2… (+55 more)
...
Cohesion: 0.15
Nodes (13): AuthRedirectError, ChapterRecordingHashes, ControllerMedia, ControllerPage(), loadChapters(), loadData(), loadOffline(), loadOnline() (+5 more)

### Community 193 - "i18n/messages.ts"
Cohesion: 0.04
Nodes (53): StatCard(), StatCardProps, BottomNav(), Header(), LABEL_KEY, LanguageSwitcher(), FONT_PRESETS, GAP_BEATS_OPTIONS (+45 more)
...
### Community 199 - "Any"
Cohesion: 0.18
Nodes (6): Any, Set the audio separator wrapper for stem separation jobs. Args:…, Set the MVSEP client for cloud stem separation. Args: mvsep_client: MvsepClient…, Set the forced aligner wrapper for forced alignment jobs. Args: wrapper:…, Set QuotaWaiter instances for free-only patient mode. Args: mvsep: QuotaWaiter…, Set the Qwen3 ASR client singleton for LRC jobs. Args: qwen3_client:…
...
### Community 202 - "Json"
Cohesion: 0.29
Nodes (6): Json, load_verdicts(), main(), Path, _render_report(), Embedding helpers — load_theme_anchors kept for theme-anchors sync.
...
Cohesion: 0.08
Nodes (18): BaseSettings, field_validator, Validate BPM algorithm version to fail fast on typos., Analysis service configuration., Convert empty-string env vars to None for Optional[int] fields. pydantic-…, Ensure YouTube transcript concurrency is at least 0 (0 = disabled)., Compute cgroup-aware default when not explicitly configured (<=0)., Compute cgroup-aware default when not explicitly configured (<=0). Same pattern… (+10 more)
...
Cohesion: 0.03
Nodes (56): AudioSegment, AppConfig, Initialize the application. Args: config: Application configuration, ExportProgressScreen, AppState, Pressed, Screen, Update UI with progress (called from main thread). Args: progress: Current… (+48 more)
...
Cohesion: 0.08
Nodes (17): identify_editor_role(), Constants for the Component Metadata editor TUI (v6). v6 changes from v5: - New…, Map a DB SongComponent to its editor-level role key, or None if not essential.…, Per-song runtime state within the editor., Sync legacy fields from components dict if not explicitly set., Return the component for an editor-level role key., Roles that have a non-None component, in canonical display order., SongSession (+9 more)
...
Cohesion: 0.05
Nodes (47): { GET, POST }, DELETE(), GET(), DEFAULTS, GET(), PUT(), VALID_FONT_PRESETS, VALID_FONTS (+39 more)
...
Cohesion: 0.22
Nodes (8): LogRecord, configure_logging(), JobIdFormatter, _JobStatusAccessFilter, Drop uvicorn access-log records for GET /api/v1/jobs* (status + list polls)., Custom formatter that adds job_id prefix from contextvar. Format: %(asctime)s -…, Format log record with job_id from context., Configure logging with job_id support. Args: level: Logging level (default:…
...
Cohesion: 0.05
Nodes (58): OfflineClient(), OfflineRow, RenderForm, RenderJobData, RenderPageClient(), RenderScreenState, RenderState, RenderSubmitted (+50 more)

### Community 276 - "Song"
Cohesion: 0.07
Nodes (27): Get the title to display., Get the key to display., Get a songset with resolved items using batch queries (Fix 10). Steps: 1. Fetch…, Songset item with resolved song/recording details. Attributes: item: The…, Check if this item is orphaned (missing or soft-deleted reference)., SongsetItemWithDetails, _dedupe_songset_name(), _format_duration() (+19 more)
...
Cohesion: 0.03
Nodes (117): Logging configuration with job_id context support. Uses contextvars to…, Set the current job_id in the context. Args: job_id: Job ID to set, or None to…, set_job_id(), Job, JobResult, LrcOptions, field_validator, Options for LRC generation jobs. (+109 more)
...
Cohesion: 0.17
Nodes (3): LRCEditorScreen, Resize, Main interactive LRC editor screen. Provides: - Main lyrics preview area…
...
## Knowledge Gaps
- **1394 isolated node(s):** `Debug`, `Staging`, `Release`, `Unknown`, `Unrendered` (+1389 more)
