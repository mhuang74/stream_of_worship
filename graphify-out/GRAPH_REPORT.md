# Graph Report - stream_of_worship  (2026-09-20)

## Corpus Check
- 874 files · ~739,863 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10216 nodes · 20699 edges · 435 communities (353 shown, 82 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 879 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d002d141`
...
## Communities (435 total, 82 thin omitted)

### Community 0 - "SongsetClient"
Cohesion: 0.03
Nodes (82): Get a songset with resolved items using batch queries (Fix 10). Steps: 1. Fetch…, construct_songset(), _dedupe_songset_name(), _format_duration(), _pick_song_interactive(), Console, Recording, Song (+74 more)

### Community 1 - "useConnectivity.ts"
Cohesion: 0.08
Nodes (21): HomePageClient(), SongsetRow(), Connectivity, ConnectivityProbe, getConnectivity(), listeners, notify(), probeConnectivity() (+13 more)
...
Cohesion: 0.05
Nodes (44): FavoritesClient(), FavoritesClientProps, LyricsEditor(), LyricsEditorProps, formatTime(), LyricsReviewSheet(), LyricsReviewSheetProps, TABS (+36 more)

### Community 4 - "datetime"
Cohesion: 0.02
Nodes (105): datetime, format_timestamp(), Format seconds as [mm:ss.xx] timestamp. Args: seconds: Time in seconds Returns:…, Main TUI application for Stream of Worship User App. Textual-based application…, AppConfig, ensure_app_config_exists(), Configuration management for sow-app TUI. Manages app-specific settings for…, Ensure all configured directories exist. (+97 more)
...
Cohesion: 0.04
Nodes (57): SettingsPage(), PlaybackControls(), PlaybackControlsProps, PreviousRenderJobData, FavoriteButton(), escapeCssSelectorValue(), SongList(), SongListItem (+49 more)
...
### Community 11 - "SettingsForm.tsx"
Cohesion: 0.08
Nodes (41): ForgotPasswordPage(), handleSubmit(), validate(), LoginPage(), handleSubmit(), validate(), RegisterPage(), handleSubmit() (+33 more)
...
Cohesion: 0.09
Nodes (43): GET(), GET(), AlbumFilterSchema, POST(), RequestSchema, FavoriteContext, loadFavoriteContext(), buildBpmPredicate() (+35 more)
...
### Community 23 - "SongsetEditorClient.tsx"
Cohesion: 0.04
Nodes (79): RenderForm, RenderJobData, RenderPageClient(), RenderScreenState, RenderState, RenderSubmitted, SongsetData, ADR-0002 (+71 more)
...
### Community 25 - "ConnectionProvider"
Cohesion: 0.05
Nodes (41): add_user(), delete_user(), _get_user_client(), list_users(), _load_config(), _print_cascade_preview(), command, Path (+33 more)
...
Cohesion: 0.08
Nodes (22): ResetPasswordForm(), handleSubmit(), validate(), DEFAULT_SETTINGS, fetchSettings(), loadSettings(), ShareAudioPage(), ShareData (+14 more)
...
### Community 29 - "LyricJumpList.tsx"
Cohesion: 0.11
Nodes (23): CURSOR_COLORS, LyricJumpList(), LyricJumpListProps, OfflinePlayback, isIOS(), Chapter, ChapterLine, CURSOR_LEAD_SECONDS (+15 more)

### Community 30 - "AudioPlayerContext.tsx"
Cohesion: 0.05
Nodes (52): AudioPlayerBar(), LyricsErrorFallback(), GlobalAudioPlayerProps, PlaybarRouteGuard(), ContainingSongset, LocateSongsetsPopover(), PlayerLyricsPanel(), PlayerLyricsPanelProps (+44 more)
...
Cohesion: 0.03
Nodes (60): FastAPI, LogRecord, Stream of Worship Analysis Service., configure_logging(), JobIdFormatter, _JobStatusAccessFilter, Logging configuration with job_id context support. Uses contextvars to…, Drop uvicorn access-log records for GET /api/v1/jobs* (status + list polls). (+52 more)

### Community 33 - "youtube_transcript.py"
Cohesion: 0.05
Nodes (47): build_correction_prompt(), _build_proxy_config(), _extract_cue_timings(), extract_video_id(), fetch_youtube_transcript(), _find_best_transcript(), insert_gap_placeholder_lines(), _is_permanently_unavailable_error() (+39 more)
...
Cohesion: 0.04
Nodes (50): Set the current job_id in the context. Args: job_id: Job ID to set, or None to…, set_job_id(), Job, JobResult, Result data for a completed job., Represents a job in the queue., Insert a new job record. Args: job: Job to insert, format_timestamp() (+42 more)
...
Cohesion: 0.15
Nodes (12): OfflineArtifactMetadata, ArtifactDownloadRequest, ArtifactDownloadScheduler, canonicalTitle(), OfflineArtifactKind, parseArtifactDownloadTitle(), ArtifactDownloadCoordinatorTest, ArtifactDownloadScheduler (+4 more)
...
Cohesion: 0.05
Nodes (49): { GET, POST }, DELETE(), DELETE(), GET(), DEFAULTS, GET(), PUT(), VALID_FONT_PRESETS (+41 more)
...
### Community 49 - "i18n/messages.ts"
Cohesion: 0.05
Nodes (47): geistMono, geistSans, metadata, GlobalAudioPlayer(), BottomNav(), Header(), LABEL_KEY, LanguageSwitcher() (+39 more)

### Community 50 - "LyricsFeedbackRow.tsx"
Cohesion: 0.22
Nodes (10): chipsForSituation(), LyricsFeedbackRow(), LyricsFeedbackRowProps, LyricsSituationKind, FeedbackRating, FeedbackReason, LyricsFeedbackResult, LyricsFeedbackState (+2 more)
...
### Community 52 - "HomePageClient.tsx"
Cohesion: 0.05
Nodes (53): HomePageClientProps, ShareDialog, formatDuration(), PublicSongsetItem, ShareData, SharePage(), ShareDialog, DashboardSongset (+45 more)

### Community 53 - "FakeSongsetsRepository"
Cohesion: 0.14
Nodes (10): ClobberingSongsetsRepository, detail(), FakeSongsetsRepository, item(), ReorderItemRequest, SongsetDetail, SongsetItem, TransitionSettings (+2 more)

### Community 54 - "lrc_jobs.py"
Cohesion: 0.03
...
Cohesion: 0.09
Nodes (21): canDocumentFullscreenSnapshot(), canVideoFullscreenSnapshot(), clamp(), ControllerPlayer(), ControllerPlayerBaseProps, ControllerPlayerProps, formatTime(), PendingResume (+13 more)
...
Cohesion: 0.02
Nodes (78): _init_download_worker(), _print_dry_run(), Print dry run information showing what would be processed. Args: db_client:…, Per-thread initializer: create a ConnectionProvider + DatabaseClient. Called…, DatabaseClient, Connection, Recording, Song (+70 more)
...
### Community 63 - "album-filter.ts"
Cohesion: 0.17
Nodes (25): SemanticSearchProps, UseSemanticSearchOptions, AlbumMultiSelect(), AlbumMultiSelectProps, BpmRangeMultiSelectProps, StructuredSearchCriteria, SharedFiltersProps, SongSearchProps (+17 more)
...
### Community 65 - "judge_results.py"
Cohesion: 0.11
Nodes (24): extract_video_id(), parse_lrc_response(), Parse LLM response and extract valid LRC lines. Args: response: LLM response…, Extract YouTube video ID from URL. Args: youtube_url: YouTube URL Returns:…, bootstrap_analysis_src(), judge_official_lines(), JudgeParseError, parse_judge_json() (+16 more)

### Community 66 - "ThemeClassifier"
Cohesion: 0.10
...
Cohesion: 0.08
Nodes (46): addFavoriteSchema, GET(), POST(), loadPage(), FavoritesPage(), RootLayout(), HomePage(), sql (+38 more)
...
### Community 77 - "TransitionBuilderApp"
Cohesion: 0.12
...
Cohesion: 0.03
Nodes (146): AbstractEventLoop, Service configuration using pydantic-settings., _extract_lyrics_for_component(), has_cached_llm_fields(), _is_essential(), _lyric_hash(), LLM-based theme and vocal posture classification for song components., Extract lyric lines within a component's time range from LRC content. Parses… (+138 more)

### Community 80 - "document-cache.ts"
Cohesion: 0.09
Nodes (20): ARTIFACT_FILE_TYPE, artifactCacheKeyForUrl(), artifactHandler(), RFC-9110, parseRangeHeader(), rangeResponseFrom(), cacheControllerDocument(), cacheDocumentAtPath() (+12 more)

### Community 81 - "job-manager.ts"
Cohesion: 0.07
Nodes (41): DELETE(), GET(), createRenderJobSchema, POST(), songsets, DispatchMessage, dispatchToRenderWorker(), getRenderWorkerMode() (+33 more)
...
Cohesion: 0.06
Nodes (33): @aws-sdk/client-s3, @aws-sdk/s3-request-presigner, @base-ui/react, dependencies, @aws-sdk/client-s3, @aws-sdk/s3-request-presigner, @base-ui/react, clsx (+25 more)

### Community 86 - "tui/app.py"
Cohesion: 0.05
...
### Community 94 - "main"
Cohesion: 0.25
Nodes (8): build_correction_prompt(), format_transcript_text(), main(), command, Path, Generate LRC from YouTube transcript corrected by LLM. Downloads YouTube…, Format transcript snippets as timestamped text for LLM prompt. Args:…, Build LLM prompt for lyrics correction. Args: transcript_text: Formatted…
...
Cohesion: 0.03
Nodes (64): ComponentEditorApp, PlaybackService, Textual app for the admin Component Metadata editor., Admin Component Metadata editor Textual application., identify_editor_role(), Constants for the Component Metadata editor TUI (v6). v6 changes from v5: - New…, Map a DB SongComponent to its editor-level role key, or None if not essential.…, Component Detail Panel widget for the Component Metadata editor (v6). Right… (+56 more)
...
### Community 104 - "Horizontal"
Cohesion: 0.06
Nodes (23): Horizontal, ComposeResult, Compose the screen layout., ComposeResult, Compose the screen layout., ComposeResult, Compose the screen layout., AppConfig (+15 more)
...
Cohesion: 0.03
Nodes (89): delete_song(), _delete_song_single(), _delete_songs_batch(), edit_song(), _extract_series_sort_key(), insert_song(), list_songs(), _print_duplicate_guidance() (+81 more)
...
Cohesion: 0.05
Nodes (51): Analysis service external integrations., _is_quota_exhausted(), MvsepClient, MvsepClientError, MvsepNonRetriableError, MvsepParsingError, MvsepQueueFullError, MvsepTimeoutError (+43 more)
...
Cohesion: 0.13
Nodes (19): formatDuration(), Modifier, Song, SongsetDetail, SongsetItem, parseSongsetItemTransition(), RenderStateChip(), SongBrowsePanel() (+11 more)
...
Cohesion: 0.09
Nodes (22): 1. Prerequisites, 2. Start the Development Server, 3. Verify It's Running, Adding a New Job Type, Analysis Service - Developer Guide, Architecture Overview, Audio-Separator Models (Required for Stem Separation), Development vs Production (+14 more)
...
Cohesion: 0.15
Nodes (4): ComponentMetadataTable, DataTable, Cycle: hidden → lyrics → details → hidden., Component metadata table with edit-guard-aware row navigation.
...
### Community 140 - "controller-page.test.tsx"
Cohesion: 0.11
Nodes (11): castTransportMock, { mockGetOfflineRecord }, mockPush, mockReplace, mockRouterInstance, presentationSenderMock, RENDER_JOB_RESPONSE, SHARE_RESPONSE (+3 more)
...
### Community 147 - "SongsetsClient.tsx"
Cohesion: 0.10
Nodes (23): ApiResponse, ShareDialog, SongsetsClient(), loadSongsets(), SongsetsClientProps, transformSongsets(), transformSongsetsWithOffline(), RenderComplete() (+15 more)
...
Cohesion: 0.11
Nodes (26): ShareControllerPage(), castAppIdMode(), CastMedia, clamp(), ClientErrorPayload, configuredCastReceiverAppId(), defaultCastReceiverAppId(), detectBrowser() (+18 more)
...
Cohesion: 0.02
Nodes (234): Future, Lock, _accept_key(), adaptive_interval(), _advance_song(), _aggregate_recording_theme(), analyze_recording(), _apply_manifest_writeback() (+226 more)
...
### Community 156 - "[id]/play/controller/page.tsx"
Cohesion: 0.12
Nodes (26): loadData(), AuthRedirectError, ChapterRecordingHashes, ControllerMedia, ControllerPage(), loadChapters(), loadData(), loadOffline() (+18 more)
...
### Community 160 - "RenderScreen.kt"
Cohesion: 0.11
Nodes (32): android, Composable, Modifier, SowEmptyState(), SowErrorState(), SowLoadingState(), StatePanel(), PlaybackArtifact (+24 more)

### Community 161 - "._guard_active_edit"
Cohesion: 0.19
Nodes (3): LyricLineTable, Lyrics table with preview-aware row navigation., Paste

### Community 162 - ".on_mount"
Cohesion: 0.18
Nodes (3): Path, Update CSS classes and widget visibility based on _right_panel_mode., v6. Re-renders the LyricsPanel for the current song. Skips if right panel is…
...
### Community 164 - "preflight.py"
Cohesion: 0.23
Nodes (11): bootstrap_admin_src(), now_run_id(), Resolve candidate model IDs: ``--models`` spec wins; else…, Exit 1 printing the MISSING var NAMES only (never values)., ``YYYYMMDD-HHMMSS`` UTC., Make ``stream_of_worship.admin`` importable (admin env). Idempotent., require_env(), resolve_model_ids() (+3 more)
...
### Community 170 - "songset_constructor/cache.py"
Cohesion: 0.33
...
### Community 175 - "SongsetDetailViewModel"
Cohesion: 0.11
Nodes (10): CoroutineScope, Song, StateFlow, TransitionSettings, ViewModel, SongSearchUiState, SongsetDetailUiState, SongsetDetailViewModel (+2 more)
...
Cohesion: 0.06
Nodes (43): Bundle, ComponentActivity, Modifier, SowApp(), SowNavigationBarItem(), SowShell(), Modifier, rememberSongsetsDependencies() (+35 more)
...
Cohesion: 0.03
Nodes (112): _build_fresh_editor_state(), feedback_list(), feedback_resolve(), feedback_unresolve(), _get_alignment_lyrics_text(), _load_connection_provider(), lyrics_align(), lyrics_edit() (+104 more)
...
### Community 189 - "get_app_config_path"
Cohesion: 0.09
Nodes (17): get_app_config_dir(), get_app_config_path(), get_cache_dir(), Path, Cache directory - always at standard platform location., Log directory - derived from working_dir., Output directory - derived from working_dir., Songset backup directory - derived from working_dir. (+9 more)

### Community 190 - "run"
Cohesion: 0.06
Nodes (39): backup_all_songsets(), backup_songset(), _check_catalog_health(), _check_database_connection(), _check_first_run(), config(), db_check(), main() (+31 more)
...
### Community 197 - "signed-url/route.test.ts"
Cohesion: 0.17
...
### Community 204 - "SongsetsViewModelTest.kt"
Cohesion: 0.11
Nodes (17): SongsetDetail, SongsetItem, SongsetItemRecording, SongsetItemSong, SongsetsPage, SongsetSummary, TransitionSettings, withItemsMarkedStale() (+9 more)

### Community 205 - "ShareViewModelTest.kt"
Cohesion: 0.19
Nodes (12): ArtifactDownloadCoordinator, `creates share token and loads signed download urls`(), `enqueue failure on one artifact does not block the other`(), FailingForKindScheduler, FakeDownloadScheduler, FakeRenderRepository, FakeShareRepository, ArtifactDownloadScheduler (+4 more)

### Community 206 - "RenderState"
Cohesion: 0.25
...
### Community 225 - "admin/services/asset_cache.py"
Cohesion: 0.50
...
### Community 246 - "VideoExoPlayerFactoryTest.kt"
Cohesion: 0.28
...
### Community 258 - "extract_audio_segment"
Cohesion: 0.16
...
### Community 269 - "SongsetItemWithDetails"
Cohesion: 0.25
...
### Community 283 - "AdminConfig"
Cohesion: 0.02
Nodes (118): _is_retryable_poll_error(), Exception, Whether a polling failure should be retried once (transient)., _display_stats(), _get_db_client(), init_db(), _mask_url(), command (+110 more)
...
### Community 332 - "SettingsScreenTest.kt"
Cohesion: 0.39
...
### Community 386 - "ComponentEditorScreen"
Cohesion: 0.10
Nodes (9): Compute the index of the LRC line that corresponds to the given playback…, ComponentEditorScreen, PlaybackState, Resize, Play or pause the song, anchored to the highlighted component. - If playing:…, Main interactive Component Metadata editor screen (v4). Provides: - Song…, Pause playback if the position has reached the selected component's end_time.…, v6. Update the lyrics panel's current-line highlight based on playback… (+1 more)

### Community 387 - "queue.py"
Cohesion: 0.04
Nodes (80): model_validator, LrcOptions, field_validator, Options for LRC generation jobs., Reject legacy field names that have been renamed., Local disk cache for analysis results., LLMConfigError, Exception (+72 more)
...
### Community 414 - "SowPlaybackService"
Cohesion: 0.33
Nodes (4): Intent, SowPlaybackService, MediaSession, MediaSessionService

### Community 435 - "_common.py"
Cohesion: 0.12
Nodes (31): EvalError, FixtureError, load_fixture(), load_model_ids(), load_skill_env(), load_transcript(), lrc_text(), Exception (+23 more)
...
## Knowledge Gaps
- **1398 isolated node(s):** `Debug`, `Staging`, `Release`, `Unknown`, `Unrendered` (+1393 more)
...
- **Why does `SowApiClientFactory` connect `AndroidSecureSessionCookieStore` to `AuthRepository`, `SowNavGraph.kt`, `Json`?**
  _High betweenness centrality (0.283) - this node is a cross-community bridge._
- **Why does `ArtifactSizes` connect `ShareViewModelTest.kt` to `HomePageClient.tsx`?**
