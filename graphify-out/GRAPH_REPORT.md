# Graph Report - stream_of_worship  (2026-08-24)

## Corpus Check
- 801 files · ~672,968 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9593 nodes · 19362 edges · 438 communities (342 shown, 96 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 841 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `167d6057`
...
## Communities (438 total, 96 thin omitted)

### Community 0 - "SongsetIOService"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (56): FavoritesClient(), FavoritesClientProps, DashboardSongsetCard(), ResultMode, SemanticSearch(), SemanticSearchProps, SemanticSearchResult, useSemanticSearch() (+48 more)

### Community 3 - "DatabaseClient"
Cohesion: 0.02
Nodes (85): _init_download_worker(), _print_dry_run(), Print dry run information showing what would be processed. Args: db_client:…, Per-thread initializer: create a ConnectionProvider + DatabaseClient. Called…, DatabaseClient, Connection, Recording, Song (+77 more)

### Community 4 - "audio.py"
Cohesion: 0.02
Nodes (193): Future, Lock, adaptive_interval(), _advance_song(), align_lrc_recording(), analyze_recording(), _apply_manifest_writeback(), _backfill_lyrics_batch() (+185 more)

### Community 5 - "bpm_agreement_report.py"
Cohesion: 0.11
Nodes (37): bpm_bucket_kmeans(), bpm_bucket_nominal(), build_crosstab_text(), build_html_report(), chart_cps_bpm_diagonal_bars(), chart_cps_vs_bpm_scatter(), chart_v5_cps_bar(), chart_v5_error_scatter() (+29 more)
...
Cohesion: 0.03
Nodes (82): build_correction_prompt(), extract_video_id(), format_timestamp(), format_transcript_text(), main(), parse_lrc_response(), command, Path (+74 more)
...
### Community 14 - "cn"
Cohesion: 0.05
Nodes (71): formatTime(), LyricsReviewSheet(), LyricsReviewSheetProps, TABS, TabType, formatDurationSafe(), isDifferent(), isIOS174OrLater() (+63 more)

### Community 15 - "GroupedFooter"
Cohesion: 0.24
...
### Community 18 - "._guard_active_edit"
Cohesion: 0.18
...
Cohesion: 0.05
Nodes (32): DEFAULT_SETTINGS, fetchSettings(), SettingsPage(), loadSettings(), RenderForm, RenderJobData, RenderPageClient(), RenderPageClientProps (+24 more)

### Community 21 - "Header.tsx"
Cohesion: 0.12
Nodes (15): geistMono, geistSans, metadata, GlobalAudioPlayer(), BottomNav(), navItems, Header(), Avatar() (+7 more)

### Community 22 - "renderWithLocale"
Cohesion: 0.03
Nodes (72): ResetPasswordPage(), PlayPage(), ApiResponse, ApiSongset, ApiSongsetItem, BrowseSheet, SongsetEditorClient(), SongsetEditorClientProps (+64 more)
...
Cohesion: 0.23
Nodes (5): Authenticated, AuthSessionManager, InMemorySessionCookieStore, AuthSessionManagerTest, FakeAuthApi
...
### Community 27 - "album-filter.ts"
Cohesion: 0.10
Nodes (34): AlbumMultiSelect(), BpmRangeMultiSelect(), MusicalKeyMultiSelect(), MusicalKeyMultiSelectProps, SharedFilters(), ThemeMultiSelect(), ThemeMultiSelectProps, DropdownMenu() (+26 more)
...
Cohesion: 0.08
Nodes (44): addFavoriteSchema, GET(), POST(), GET(), RouteParams, loadPage(), FavoritesPage(), HomePage() (+36 more)
...
### Community 34 - "SowNavGraph.kt"
Cohesion: 0.05
Nodes (51): android, Composable, Modifier, SowEmptyState(), SowErrorState(), SowLoadingState(), StatePanel(), label() (+43 more)
...
Cohesion: 0.07
Nodes (31): ShareDialog, ShareDialog, LyricsEditor(), LyricsEditorProps, formatBytes(), formatLimit(), ShareDialog(), ShareDialogProps (+23 more)
...
Cohesion: 0.12
Nodes (54): main(), Shared constants mirroring the webapp's constants.ts. NOTE: these duplicate…, _draft_to_proposal(), LangGraph state schema., DraftItem, JudgeItem, JudgeRanking, ProposalItem (+46 more)

### Community 53 - "messages.ts"
Cohesion: 0.05
Nodes (46): HomePageClient(), HomePageClientProps, ShareDialog, FEATURES, PublicLanding(), STEPS, formatDuration(), PublicSongsetItem (+38 more)
...
Cohesion: 0.06
Nodes (25): Launch a Textual TUI to view / review / compare / edit component metadata.…, review_components(), ComponentEditorApp, PlaybackService, Textual app for the admin Component Metadata editor., Admin Component Metadata editor Textual application., LRCFetch, Result of an LRC fetch for a single song. Attributes: song_id: Song ID content:… (+17 more)
...
### Community 60 - "Path"
Cohesion: 0.04
Nodes (69): KeyMode, _accept_key(), _aggregate_recording_theme(), cache_assets(), _colorize_visibility(), components_recording(), delete_recording(), _drain_input_buffer() (+61 more)
...
Cohesion: 0.09
Nodes (46): ForgotPasswordPage(), handleSubmit(), validate(), LoginPage(), handleSubmit(), validate(), RegisterPage(), handleSubmit() (+38 more)
...
Cohesion: 0.07
Nodes (29): { GET, POST }, DELETE(), DELETE(), GET(), GET(), auth, User, removeFavorite() (+21 more)
...
### Community 76 - "AuthApi.kt"
Cohesion: 0.18
Nodes (11): AuthApi, AuthSession, BetterAuthData, BetterAuthEnvelope, BetterAuthError, EmailPasswordRequest, Response, ResponseBody (+3 more)
...
### Community 80 - "admin/config.py"
Cohesion: 0.15
Nodes (16): ensure_config_exists(), get_config_dir(), get_config_path(), get_env_var_name(), get_secret(), Path, Configuration management for sow-admin CLI. Handles loading, saving, and…, Save configuration to TOML file. Args: path: Path to save config (defaults to… (+8 more)

### Community 81 - "AdminConfig"
Cohesion: 0.15
Nodes (12): _get_connection_provider(), command, Path, Theme-anchors commands for sow-admin. Provides ``sow-admin theme-anchors sync``…, Populate the theme_anchors table from the bundled JSON file. Reads…, sync_theme_anchors(), AdminConfig, Get a configuration value by key. Supports dot notation mapping to flat… (+4 more)

### Community 82 - "search-helpers.ts"
Cohesion: 0.08
Nodes (54): GET(), GET(), AlbumFilterSchema, POST(), RequestSchema, AlbumMultiSelectProps, BpmRangeMultiSelectProps, SharedFiltersProps (+46 more)
...
Cohesion: 0.09
Nodes (18): clamp(), ControllerPlayer(), formatTime(), PendingResume, PresentationFallback, LyricJumpList(), LyricJumpListProps, PlaybackControls() (+10 more)

### Community 119 - "users.py"
Cohesion: 0.29
Nodes (13): add_user(), delete_user(), _get_user_client(), list_users(), _load_config(), _print_cascade_preview(), command, Path (+5 more)
...
Cohesion: 0.08
Nodes (39): create_simple_crossfade(), determine_crossfade_durations(), generate_all_transitions(), generate_transition_filename(), load_analysis_results(), log(), main(), print_summary_report() (+31 more)
...
### Community 131 - "share-token-cast-expiry.test.ts"
Cohesion: 0.15
...
Cohesion: 0.08
Nodes (21): Recording, Song, SongsPage, parseSongsetItemTransition(), SongsetItemTransitionParseResult, SongsetsScreensTest, ClobberingSongsetsRepository, detail() (+13 more)
...
### Community 149 - "songset_constructor/config.py"
Cohesion: 0.29
Nodes (4): Runtime configuration for the songset constructor., Checkpointer selection — always InMemorySaver for v3., persist_proposals(), Atomic persistence of constructed songsets.
...
### Community 162 - "_save_base64"
Cohesion: 0.24
Nodes (11): Figure, chart_consensus_radius_hist(), chart_disputed_strip(), chart_method_deviation_box(), chart_v5_delta_histogram(), _make_fig(), Overlay histograms of err_v5_raw − err_v4_raw and err_v5_oct − err_v4_oct.…, Histogram of per-song radius (max − min of octave-normalized BPMs). Vertical… (+3 more)

### Community 163 - "nodes.py"
Cohesion: 0.15
Nodes (34): event(), Trace event helpers for graph nodes., build_graph(), Build the songset constructor graph., choose_checkpointer(), build_chat_model(), LLM construction and structured-output helpers., structured() (+26 more)
...
### Community 173 - "._refresh_hero"
Cohesion: 0.16
Nodes (8): CellHighlighted, CellSelected, RowHighlighted, Submitted, Merge dirty edits into R2 components.json and upload., Replace session components with refreshed SongComponent objects reflecting the…, v4 NEW. Re-renders the ComponentHeroPanel against the current state., v6. Re-renders the ComponentDetailPanel against the current state. Skips if…
...
### Community 175 - "forced_alignment.py"
Cohesion: 0.20
...
### Community 178 - "signed-url/route.test.ts"
Cohesion: 0.17
...
### Community 182 - "SowPlaybackService"
Cohesion: 0.15
...
### Community 184 - "PlaylistMetadata"
Cohesion: 0.20
...
### Community 187 - "How the Render Worker Is Triggered from Next.js"
Cohesion: 0.22
...
### Community 191 - ".load"
Cohesion: 0.02
Nodes (135): datetime, list_recordings(), List audio recordings. Display recordings from the database with optional…, delete_song(), _delete_song_single(), _delete_songs_batch(), edit_song(), _extract_series_sort_key() (+127 more)
...
### Community 193 - "AuthScreens.kt"
Cohesion: 0.07
Nodes (34): Bundle, ComponentActivity, Modifier, SowApp(), SowNavigationBarItem(), SowShell(), BottomNavDestination, createRoute() (+26 more)

### Community 194 - "useSongLyrics.ts"
Cohesion: 0.28
Nodes (7): CachedResult, clearLyricsCache(), lyricsCache, NULL_RESULT, SongLyricsResult, useSongLyrics(), mockFetch

### Community 195 - "transcribe_audio"
Cohesion: 0.20
...
### Community 197 - "component_editor/screen.py"
Cohesion: 0.04
Nodes (85): _build_fresh_editor_state(), edit_lrc(), _prompt_choice(), Upload a manually created LRC file to R2. Use this when: 1. The LRC generation…, Interactively edit LRC timestamps for a song recording. Downloads/caches the…, Build a fresh EditorState from transcribed content or catalog lyrics., Prompt the user to choose from a list of options. Returns: Index of the chosen…, upload_lrc() (+77 more)

### Community 198 - ".add_transition"
Cohesion: 0.29
...
### Community 202 - "SongsetItemWithDetails"
Cohesion: 0.20
...
### Community 204 - ".action_preview_continuous"
Cohesion: 0.23
...
Cohesion: 0.12
Nodes (38): compute_dtw_signal(), compute_signals_for_song(), download_r2(), dtw_path_stats(), embed_framewise(), _get_expected_tone_slopes(), LineSignals, _load_embedder() (+30 more)
...
### Community 240 - "error_vs_stored"
Cohesion: 0.33
Nodes (6): error_vs_stored(), kmeans_3(), ndarray, K-means 3-cluster on a 1-D array. Returns ``(labels, sorted_centers, cutoffs)``…, Compute raw + octave-corrected error metrics vs stored BPM. Returns dict with…, _stats()
...
### Community 272 - "extract_audio_segment"
Cohesion: 0.16
...
### Community 309 - "octave_normalize"
Cohesion: 0.50
...
### Community 473 - "Json"
Cohesion: 0.16
Nodes (11): SowApiClientFactory, Json, analyze_song(), calculate_compatibility(), create_simple_crossfade(), main(), Calculate compatibility scores between two songs. Scoring: - Tempo: 100 if <5%…, Create equal-power crossfade between two songs. Algorithm: 1. Load stereo audio… (+3 more)
...
### Community 508 - "songset_constructor/cache.py"
Cohesion: 0.33
...
## Knowledge Gaps
- **1216 isolated node(s):** `Debug`, `Staging`, `Release`, `Unknown`, `Unrendered` (+1211 more)
...
- **Why does `SowApiClientFactory` connect `Json` to `AndroidSecureSessionCookieStore`, `AuthScreens.kt`, `SowNavGraph.kt`, `AuthRepository`?**
