# Graph Report - sow_nonuser_footer_fix  (2026-09-07)

## Corpus Check
- 809 files · ~678,671 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9638 nodes · 19475 edges · 437 communities (358 shown, 79 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 847 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `06745e89`
...
## Communities (437 total, 79 thin omitted)
...
### Community 14 - "cn"
Cohesion: 0.05
Nodes (73): ForgotPasswordPage(), handleSubmit(), validate(), LoginPage(), handleSubmit(), validate(), RegisterPage(), handleSubmit() (+65 more)
...
### Community 20 - "FakeAuthController"
Cohesion: 0.19
...
### Community 22 - "SongsetItemWithDetails"
Cohesion: 0.20
...
Cohesion: 0.22
Nodes (7): AuthRepository, AuthSessionManager, InMemorySessionCookieStore, AuthSessionManagerTest, FakeAuthApi, Response, ResponseBody
...
Cohesion: 0.06
Nodes (67): RenderPageClientProps, RenderFormData, SemanticSearchProps, UseSemanticSearchOptions, AlbumMultiSelect(), AlbumMultiSelectProps, BpmRangeMultiSelect(), BpmRangeMultiSelectProps (+59 more)
...
Cohesion: 0.04
Nodes (62): FavoritesClient(), FavoritesClientProps, HomePageClient(), HomePageClientProps, DashboardSongset, LyricsEditor(), LyricsEditorProps, formatTime() (+54 more)
...
Cohesion: 0.04
Nodes (65): ShareDialog, PlayPage(), RenderJobData, SongsetData, SongsetItem, ApiResponse, ApiSongset, ApiSongsetItem (+57 more)
...
### Community 53 - "renderWithLocale"
Cohesion: 0.03
Nodes (90): AboutContent(), AboutPage(), geistMono, geistSans, metadata, RootLayout(), BuildStamp(), FEATURES (+82 more)
...
Cohesion: 0.03
Nodes (59): ResetPasswordForm(), handleSubmit(), validate(), DEFAULT_SETTINGS, ShareAudioPage(), ShareData, ShareControllerPage(), loadData() (+51 more)
...
### Community 192 - "AuthState"
Cohesion: 0.28
Nodes (5): Authenticated, AuthState, Error, Restoring, Unauthenticated
...
### Community 199 - "usePresentationSender.test.ts"
Cohesion: 0.33
...
Cohesion: 0.11
Nodes (21): Bundle, ComponentActivity, Modifier, SowApp(), SowNavigationBarItem(), SowShell(), AuthController, StateFlow (+13 more)
...
Cohesion: 0.04
Nodes (43): build_correction_prompt(), extract_video_id(), format_transcript_text(), main(), parse_lrc_response(), command, Path, Parse LLM response and extract valid LRC lines. Args: response: LLM response… (+35 more)
...
Cohesion: 0.13
Nodes (17): ApiError, ApiErrorKind, Malformed, Network, Server, Unauthorized, Unknown, Validation (+9 more)
