# Graph Report - stream_of_worship  (2026-09-17)

## Corpus Check
- 851 files · ~729,024 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10038 nodes · 20412 edges · 457 communities (363 shown, 94 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 880 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b42d90cc`
...
## Communities (457 total, 94 thin omitted)

### Community 0 - "SongsetClient"
Cohesion: 0.03
Nodes (80): construct_songset(), _dedupe_songset_name(), _format_duration(), _pick_song_interactive(), Console, Recording, Song, Helper functions for ``sow-admin songset create``. Split off from… (+72 more)

### Community 1 - "ReadOnlyClient"
Cohesion: 0.04
Nodes (42): _keyword_search(), main(), _pgvector_search(), Semantic search using pgvector or theme-vocab fallback., Generate embedding for query and search via pgvector cosine distance., Match query against THEME_VOCAB to identify themes, then find songs with high…, Keyword search using ReadOnlyClient.search_songs (ILIKE)., _semantic_search() (+34 more)
...
Cohesion: 0.02
Nodes (80): build_db_client(), _print_dry_run(), Print dry run information showing what would be processed. Args: db_client:…, DatabaseClient, Connection, Recording, Song, Context manager for database transactions. Yields: psycopg connection with an… (+72 more)

### Community 4 - "RenderPageClient.tsx"
Cohesion: 0.05
Nodes (33): DEFAULT_SETTINGS, fetchSettings(), SettingsPage(), loadSettings(), RenderForm, RenderJobData, RenderPageClient(), RenderScreenState (+25 more)
...
### Community 9 - "SongsetsScreens.kt"
Cohesion: 0.11
Nodes (20): label(), RenderState, Failed, Fresh, Rendering, Stale, Unrendered, SongsetDetail (+12 more)
...
Cohesion: 0.05
Nodes (40): AppConfig, Initialize the application. Args: config: Application configuration, add_user(), delete_user(), _get_user_client(), list_users(), _load_config(), _print_cascade_preview() (+32 more)
...
Cohesion: 0.13
Nodes (29): AlbumMultiSelect(), BpmRangeMultiSelect(), BpmRangeMultiSelectProps, MusicalKeyMultiSelect(), MusicalKeyMultiSelectProps, SharedFilters(), ThemeMultiSelect(), ThemeMultiSelectProps (+21 more)

### Community 16 - "SongsetEditor.tsx"
Cohesion: 0.05
Nodes (53): ShareDialog, ApiResponse, ApiSongset, ShareDialog, SongsetEditorClient(), transformItems(), ApiResponse, ApiSongset (+45 more)
...
Cohesion: 0.02
Nodes (141): Set the current job_id in the context. Args: job_id: Job ID to set, or None to…, set_job_id(), AnalyzeJobRequest, AnalyzeOptions, ComponentAnalysisJobRequest, ComponentAnalysisOptions, ComponentResult, EmbeddingJobRequest (+133 more)
...
Cohesion: 0.03
Nodes (57): ResetPasswordPage(), PlayPage(), loadSongset(), offerOfflineEntry(), LyricJumpList(), RENDER_JOB_POLL_INTERVAL_MS, RenderSubmitted(), mockPause (+49 more)
...
Cohesion: 0.18
Nodes (9): EmailPasswordRequest, RegisterRequest, Authenticated, AuthSessionManager, InMemorySessionCookieStore, AuthSessionManagerTest, FakeAuthApi, Response (+1 more)
...
Cohesion: 0.09
Nodes (44): bootstrap_admin_src(), bootstrap_analysis_src(), EvalError, FixtureError, load_fixture(), load_model_ids(), load_skill_env(), load_transcript() (+36 more)

### Community 33 - "youtube_transcript.py"
Cohesion: 0.05
Nodes (53): _is_llm_rate_limited_error(), Detect whether an exception is an LLM 429 rate-limit error. Detection…, build_correction_prompt(), _build_proxy_config(), _extract_cue_timings(), extract_video_id(), fetch_youtube_transcript(), _find_best_transcript() (+45 more)

### Community 34 - "CatalogService"
Cohesion: 0.03
Nodes (43): build_correction_prompt(), format_transcript_text(), main(), command, Path, Generate LRC from YouTube transcript corrected by LLM. Downloads YouTube…, Format transcript snippets as timestamped text for LLM prompt. Args:…, Build LLM prompt for lyrics correction. Args: transcript_text: Formatted… (+35 more)
...
### Community 36 - "SongsetDetailViewModel"
Cohesion: 0.07
Nodes (20): Modifier, Song, SongsetDetail, SongBrowsePanel(), SongSearchResult(), SongsetDetailScreen(), SongsetHeader(), CoroutineScope (+12 more)

### Community 37 - "offline-index.ts"
Cohesion: 0.12
Nodes (20): invalidateArtifactCache(), getOfflineRecord(), isOfflineIndexAvailable(), listOfflineRecords(), OFFLINE_INDEX_DB_NAME, OFFLINE_INDEX_STORE_NAME, OfflineSongsetRecord, openIndexDb() (+12 more)

### Community 38 - "MvsepClient"
Cohesion: 0.08
...
Cohesion: 0.10
Nodes (20): canDocumentFullscreenSnapshot(), canVideoFullscreenSnapshot(), clamp(), ControllerPlayer(), ControllerPlayerBaseProps, ControllerPlayerProps, formatTime(), PendingResume (+12 more)
...
Cohesion: 0.05
Nodes (39): _is_retryable_poll_error(), Exception, Whether a polling failure should be retried once (transient)., _get_alignment_lyrics_text(), lyrics_align(), Console, R2Client, Return lyrics text for forced alignment, preferring existing LRC over nominal… (+31 more)

### Community 50 - "BrowseSheet.tsx"
Cohesion: 0.06
Nodes (56): FavoritesClient(), FavoritesClientProps, HomePageClient(), HomePageClientProps, ApiSongsetItem, BrowseSheet, SongsetEditorClientProps, DashboardSongset (+48 more)
...
Cohesion: 0.10
Nodes (18): Recording, Song, SongsPage, SongsetItemSong, SongsetsPage, ClobberingSongsetsRepository, detail(), FakeSongsetsRepository (+10 more)
...
Cohesion: 0.08
Nodes (55): GET(), GET(), AlbumFilterSchema, POST(), RequestSchema, FavoriteContext, loadFavoriteContext(), buildBpmPredicate() (+47 more)
...
Cohesion: 0.08
Nodes (28): OfflineStatusProps, FONT_PRESETS, GAP_BEATS_OPTIONS, isIOSLessThan174(), KEY_SHIFT_OPTIONS, LOCALE_OPTIONS, LOOP_WINDOW_OPTIONS, SettingsForm() (+20 more)
...
Cohesion: 0.12
Nodes (29): DELETE(), GET(), createRenderJobSchema, POST(), renderJobs, songsetItems, songsets, SONGSET_MAX_DURATION_SECONDS (+21 more)
...
Cohesion: 0.02
Nodes (160): AbstractEventLoop, _classify_posture_heuristic(), _extract_lyrics_for_component(), has_cached_llm_fields(), _has_religious_pronoun(), _is_essential(), _lyric_hash(), LLM-based theme and vocal posture classification for song components. (+152 more)
...
Cohesion: 0.05
Nodes (39): devDependencies, drizzle-kit, env-cmd, eslint, eslint-config-next, jsdom, postgres, tailwindcss (+31 more)
...
### Community 109 - ".load"
Cohesion: 0.02
Nodes (159): _accept_key(), analyze_recording(), cache_assets(), _colorize_visibility(), components_recording(), delete_recording(), _display_truncate(), download_audio() (+151 more)
...
### Community 119 - "SowLoadingState"
Cohesion: 0.22
Nodes (15): android, Composable, Modifier, SowEmptyState(), SowErrorState(), SowLoadingState(), StatePanel(), ChoiceRow() (+7 more)
...
Cohesion: 0.08
Nodes (39): analyze_audio(), analyze_audio_fast(), compute_loudness(), _compute_tempo_v4(), _compute_tempo_v5(), detect_key(), detect_key_fulltrack(), detect_key_segment_vote() (+31 more)
...
Cohesion: 0.09
Nodes (32): addFavoriteSchema, GET(), POST(), loadPage(), FavoritesPage(), HomePage(), sql, songs (+24 more)
...
Cohesion: 0.11
Nodes (16): ShareControllerPage(), loadData(), clamp(), UsePresentationReceiverOptions, UsePresentationReceiverResult, usePresentationSender(), UsePresentationSenderOptions, UsePresentationSenderResult (+8 more)
...
### Community 143 - "SongsetIOService"
Cohesion: 0.07
...
### Community 147 - "parse_musical_key"
Cohesion: 0.29
...
### Community 155 - "judge_results.py"
Cohesion: 0.13
Nodes (20): extract_video_id(), parse_lrc_response(), Parse LLM response and extract valid LRC lines. Args: response: LLM response…, Extract YouTube video ID from URL. Args: youtube_url: YouTube URL Returns:…, judge_official_lines(), JudgeParseError, parse_judge_json(), Official lyrics for judging/mechanical checks — tag lines excluded. A line… (+12 more)
...
Cohesion: 0.16
Nodes (25): AuthRedirectError, ChapterRecordingHashes, ControllerMedia, ControllerPage(), loadChapters(), loadData(), loadOffline(), loadOnline() (+17 more)
...
### Community 164 - "._guard_active_edit"
Cohesion: 0.19
...
### Community 166 - "ShareViewModelTest.kt"
Cohesion: 0.17
...
### Community 179 - "app/layout.tsx"
Cohesion: 0.07
Nodes (25): geistMono, geistSans, metadata, BottomNav(), Header(), LABEL_KEY, LanguageSwitcher(), OfflineIndicator() (+17 more)
...
### Community 191 - "songset_constructor/config.py"
Cohesion: 0.08
Nodes (32): _cache_age_hours(), main(), Load a cache file ignoring TTL (for stale fallback)., _try_load_stale(), event(), Trace event helpers for graph nodes., _cache_key(), _cache_path() (+24 more)

### Community 192 - ".on_button_pressed"
Cohesion: 0.20
...
### Community 193 - "messages.ts"
Cohesion: 0.05
Nodes (50): AboutContent(), BuildStamp(), FEATURES, PublicLanding(), STEPS, formatDuration(), PublicSongsetItem, ShareData (+42 more)
...
### Community 195 - "editor/screen.py"
Cohesion: 0.05
Nodes (67): _build_fresh_editor_state(), lyrics_edit(), Recording, Song, Build a fresh EditorState from transcribed content or catalog lyrics., Interactively edit LRC timestamps for a song recording. Downloads/caches the…, Lyrics Panel widget for the Component Metadata editor (v6). Right panel (lyrics…, autosave_exists() (+59 more)
...
### Community 197 - "._get_selected_item"
Cohesion: 0.24
...
Cohesion: 0.18
Nodes (10): cacheControllerDocument(), controllerDocumentPath(), deleteControllerDocument(), isLoginPage(), preload(), PreloadTarget, preloadTargets(), SOW_PAGES_CACHE_NAME (+2 more)
...
### Community 214 - "sow_analysis/logging_config.py"
Cohesion: 0.21
...
### Community 217 - "ForcedAlignerWrapper"
Cohesion: 0.15
...
### Community 220 - "AndroidArtifactDownloadScheduler"
Cohesion: 0.25
...
### Community 228 - "SowPlaybackService"
Cohesion: 0.33
...
Cohesion: 0.07
Nodes (35): { GET, POST }, DELETE(), DELETE(), GET(), GET(), POST(), signedUrlRequestSchema, generateSignedUrlResponse() (+27 more)
...
### Community 246 - "slugify"
Cohesion: 0.46
Nodes (7): load_verdicts(), main(), Path, _render_report(), Artifact-safe slug: ``/`` and ``:`` become ``-``., read_jsonl(), slugify()

### Community 247 - "ApiErrorKind"
Cohesion: 0.29
Nodes (7): ApiErrorKind, Malformed, Network, Server, Unauthorized, Unknown, Validation

### Community 248 - "zanmei.py"
Cohesion: 0.18
...
### Community 256 - "._get_selected_song"
Cohesion: 0.18
...
### Community 258 - ".on_input_blurred"
Cohesion: 0.25
...
### Community 274 - "clear_queue"
Cohesion: 0.40
Nodes (5): clear_queue(), ClearQueueResponse, BaseModel, Response for clear-queue endpoint., Cancel all queued and processing jobs. Args: admin_key: Validated admin API key…

### Community 275 - "artifact-cache.ts"
Cohesion: 0.07
Nodes (29): ARTIFACT_FILE_TYPE, artifactCacheKeyForUrl(), artifactHandler(), RFC-9110, parseRangeHeader(), rangeResponseFrom(), ARTIFACT_CACHE_NAME, artifactCacheKey() (+21 more)

### Community 276 - "LyricsErrorBoundary.test.tsx"
Cohesion: 0.17
...
### Community 310 - "._populate_lrc_table"
Cohesion: 0.33
...
### Community 323 - "GenerationScreen"
Cohesion: 0.13
...
### Community 324 - "lyrics.py"
Cohesion: 0.02
Nodes (142): _display_stats(), _get_db_client(), init_db(), _mask_url(), command, Path, Database commands for sow-admin. Provides CLI commands for database…, Print the connection info table; return True if the database is reachable. (+134 more)

### Community 328 - "admin/services/asset_cache.py"
Cohesion: 0.50
...
Cohesion: 0.02
Nodes (106): datetime, format_timestamp(), Format seconds as [mm:ss.xx] timestamp. Args: seconds: Time in seconds Returns:…, Main TUI application for Stream of Worship User App. Textual-based application…, AppConfig, ensure_app_config_exists(), get_app_config_dir(), get_app_config_path() (+98 more)
...
Cohesion: 0.09
Nodes (15): Horizontal, ComposeResult, Compose the screen layout., ComposeResult, Compose the screen layout., ComposeResult, Compose the screen layout., ComposeResult (+7 more)
...
## Knowledge Gaps
- **1317 isolated node(s):** `Debug`, `Staging`, `Release`, `Unknown`, `Unrendered` (+1312 more)
...
- **Why does `SowApiClientFactory` connect `Json` to `AndroidSecureSessionCookieStore`, `SowNavGraph.kt`, `AuthRepository`?**
