...
from sow_legacy_cli_tui.tui.models.playlist import Playlist
from sow_legacy_cli_tui.tui.models.transition import TransitionParams
...
class PlaylistScreen(Vertical):
    ...
    def _on_save_playlist(self) -> None:
        ...
        from sow_legacy_cli_tui.core.paths import get_playlists_path
    ...
    def on_key(self, event) -> None:
        ...
        if event.key == "q":
            from sow_legacy_cli_tui.tui.app import TransitionBuilderApp
