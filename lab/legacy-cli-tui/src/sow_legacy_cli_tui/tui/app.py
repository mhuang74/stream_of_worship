...
from sow_legacy_cli_tui.core.paths import ensure_directories
from sow_legacy_cli_tui.tui.state import AppState, ActiveScreen
...
from sow_legacy_cli_tui.tui.utils.logger import (
    init_error_logger,
    init_session_logger,
)
...
class TransitionBuilderApp(App):
    ...
    def _get_generation_screen(self):
        ...
        if self._generation_screen is None:
            from sow_legacy_cli_tui.tui.screens.generation import GenerationScreen
    ...
    def _get_history_screen(self):
        ...
        if self._history_screen is None:
            from sow_legacy_cli_tui.tui.screens.history import HistoryScreen
    ...
    def _get_playlist_screen(self):
        ...
        if self._playlist_screen is None:
            from sow_legacy_cli_tui.tui.screens.playlist import PlaylistScreen
