...
from sow_legacy_cli_tui.core.config import Config, ensure_config_exists
...
def handle_ingest(args, config: Config):
    ...
    if args.ingest_command == "analyze":
        ...
        if args.song_id:
            ...
            from sow_legacy_cli_tui.core.paths import get_song_dir
            from sow_legacy_cli_tui.core.catalog import CatalogIndex
