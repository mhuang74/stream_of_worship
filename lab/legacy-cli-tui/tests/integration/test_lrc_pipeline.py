...
try:
    from sow_legacy_cli_tui.ingestion.lrc_generator import (
        LRCLine,
        WhisperWord,
        LRCGenerator,
        parse_lrc_file,
...
class TestLLMAlignment:
    ...
    @patch("sow_legacy_cli_tui.ingestion.lrc_generator.openai")
...
class TestEndToEndWorkflow:
    ...
    @patch("sow_legacy_cli_tui.ingestion.lrc_generator.whisper")
    @patch("sow_legacy_cli_tui.ingestion.lrc_generator.openai")
    @patch("sow_legacy_cli_tui.ingestion.lrc_generator.get_whisper_cache_path")
