...
from sow_legacy_cli_tui.tui.models.song import Song as TUISong
...
class TestTransitionGenerationService:
    ...
    @patch("sow_legacy_cli_tui.tui.services.generation.get_error_logger")
    @patch("sow_legacy_cli_tui.tui.services.generation.get_session_logger")
