...
class TestEnsureDirectories:
    ...
    @patch("sow_legacy_cli_tui.core.paths.get_user_data_dir")
    @patch("sow_legacy_cli_tui.core.paths.get_cache_dir")
...
class TestPathHelperFunctions:
    ...
    def test_get_recording_cache_path_default(self):
        ...
        with patch("sow_legacy_cli_tui.core.paths.get_cache_dir") as mock:
