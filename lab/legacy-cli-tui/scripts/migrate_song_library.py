...
from sow_legacy_cli_tui.core.catalog import Song, CatalogIndex


# Configuration
POC_RESULTS_PATH = Path("poc/output_allinone/poc_full_results.json")
LYRICS_SOURCE_PATH = Path("data/lyrics/songs")
AUDIO_SOURCE_PATH = Path("poc/audio")
