...
from sow_lab_app.services.audio_engine import AudioEngine
from sow_lab_app.services.catalog import CatalogService
from sow_lab_app.services.export import ExportService
from sow_lab_app.services.playback import PlaybackService
from sow_lab_app.services.video_engine import VideoEngine
from sow_lab_app.state import AppScreen, AppState
...
class SowApp(App):
    ...
    def _create_screen(self, screen: AppScreen):
        ...
        if screen == AppScreen.LOGIN:
            ...
            from sow_lab_app.screens.transition_detail import TransitionDetailScreen

            return TransitionDetailScreen(self.state, self.songset_client, self.playback)
        elif screen == AppScreen.EXPORT_PROGRESS:
            from sow_lab_app.screens.export_progress import ExportProgressScreen

            return ExportProgressScreen(self.state, self.export_service)
        elif screen == AppScreen.LYRICS_PREVIEW:
            from sow_lab_app.screens.lyrics_preview import LyricsPreviewScreen
            ...
            from sow_lab_app.screens.settings import SettingsScreen
