...
> **This component is deprecated.** The [Web App](../../../delivery/webapp/README.md) (`sow-webapp`) is now the primary end-user interface for worship leaders and media teams. The TUI may not be fully migrated to the shared PostgreSQL (Neon) database and is not actively maintained.
