...
from stream_of_worship.db.app.models import SongsetItem
from sow_lab_app.logging_config import get_logger
from sow_lab_app.services.asset_cache import AssetCache
from sow_lab_app.services.audio_engine import AudioSegmentInfo, ExportResult

logger = get_logger(__name__)


def get_bundled_font_path() -> Path:
    """Return the packaged Traditional Chinese font path."""
    return Path(str(resources.files("sow_lab_app.assets.fonts").joinpath("NotoSansTC-Bold.ttf")))
