...
from sow_lab_app.services.export import (
    ExportService,
    ExportState,
    ExportProgress,
    ExportJob,
)
from sow_lab_app.services.audio_engine import ExportResult
...
class TestExportJob:
    ...
    def test_export_job_dataclass(self, sample_songset, sample_items):
        ...
        from sow_lab_app.services.video_engine import VideoTemplate
