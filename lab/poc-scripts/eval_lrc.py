...
uv run --project lab/poc-scripts --extra lrc_eval eval_lrc.py wo_yao_quan_xin_zan_mei_244

# Local file mode
uv run --project lab/poc-scripts --extra lrc_eval eval_lrc.py --lrc lyrics.lrc --audio vocals.wav -e sensevoice

# VAD-based segmentation + verbose output
uv run --project lab/poc-scripts --extra lrc_eval eval_lrc.py <song_id> -e paraformer --segment-mode vad --verbose

# JSON output for batch processing
uv run --project lab/poc-scripts --extra lrc_eval eval_lrc.py <song_id> --json --output results.json
"""
...
def main(
    ...
    2. Compare engines:
       uv run --project lab/poc-scripts --extra lrc_eval eval_lrc.py <song_id> --engine whisper
       uv run --project lab/poc-scripts --extra lrc_eval eval_lrc.py <song_id> --engine sensevoice
       uv run --project lab/poc-scripts --extra lrc_eval eval_lrc.py <song_id> --engine paraformer

    3. VAD-based segmentation (instead of default LRC):
       uv run --project lab/poc-scripts --extra lrc_eval eval_lrc.py <song_id> -e paraformer --segment-mode vad

    4. Disable pinyin mode (character-exact matching):
       uv run --project lab/poc-scripts --extra lrc_eval eval_lrc.py <song_id> --no-pinyin-mode
