...
Usage:
    python lyrics_scraper.py                 # Scrape all songs
    python lyrics_scraper.py --test          # Test with single song
    python lyrics_scraper.py --limit 10      # Scrape first 10 songs
    python lyrics_scraper.py --verbose       # Show detailed progress
"""
