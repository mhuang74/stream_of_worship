...
def synthetic_pool() -> list[SongCandidate]:
    return [
        SongCandidate(song_id="s1", title="讚美主", recording_hash_prefix="h001", tempo_bpm=124, musical_key="G", musical_mode="maj", key_confidence=0.9, phase=1, themes={"讚美": 1}, composer="A"),
        ...
        SongCandidate(song_id="s5", title="跟隨主", recording_hash_prefix="h005", tempo_bpm=78, musical_key="B", musical_mode="min", key_confidence=0.9, phase=5, themes={"跟隨": 1}, composer="E"),
        SongCandidate(song_id="s6", title="復興", recording_hash_prefix="h006", tempo_bpm=82, musical_key="F#", musical_mode="min", key_confidence=0.9, phase=5, themes={"復興": 1}, composer="F"),
    ]
