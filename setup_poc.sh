...
echo ""
echo "3. Open your browser to the Jupyter Lab URL shown in the console"
echo "   (Usually: http://localhost:8888)"
echo ""
echo "4. Navigate to notebooks/01_POC_Analysis.ipynb"
echo ""
echo "5. Run all cells: Menu → Run → Run All Cells"
echo ""
echo "6. Review outputs in poc_output/ directory"
echo ""
echo "============================================================================"
