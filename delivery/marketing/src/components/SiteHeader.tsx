  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur">
      <div className="flex h-14 items-center gap-4 px-4">
        <Link href={base === "" ? "/" : base} className="flex items-center gap-2 font-semibold">
        ...
        <nav className="flex items-center gap-6 ml-6" aria-label={t(locale, "nav.main.ariaLabel")}>
          ...
          <Link
            href={otherHref}
            className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors rounded border border-border px-2 py-0.5"
          >
