...
// ---------------------------------------------------------------------------
// Catalog tables (managed by admin CLI, read-only from delivery/webapp)
// ---------------------------------------------------------------------------
...
export const songs = pgTable(
  "songs",
  {
    ...
    musicalKeyRoot: text("musical_key_root"),
    musicalKeyMode: text("musical_key_mode"),
    musicalKeyStartRoot: text("musical_key_start_root"),
    musicalKeyEndRoot: text("musical_key_end_root"),
    musicalKeyStartPitchClass: integer("musical_key_start_pitch_class"),
    musicalKeyEndPitchClass: integer("musical_key_end_pitch_class"),
    musicalKeyParseStatus: text("musical_key_parse_status"),
...
export const recordings = pgTable("recordings", {
  ...
  keyAlgorithmVersion: text("key_algorithm_version"),
  keyScoreMargin: real("key_score_margin"),
  keyWindowAgreement: real("key_window_agreement"),
  keyCandidates: text("key_candidates"),
  keyDetectedAt: timestamp("key_detected_at", { withTimezone: true }),
...
// ---------------------------------------------------------------------------
// New delivery/webapp table: render_jobs
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// New delivery/webapp table: song_embedding (pgvector for semantic search)
...
// ---------------------------------------------------------------------------
// New delivery/webapp table: song_line_embedding (pgvector for snippet matching)
