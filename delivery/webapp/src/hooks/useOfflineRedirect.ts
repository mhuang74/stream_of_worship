 ...
 * /worship when the OS reports no network. `replace` — no history junk; a
 * full document navigation so the browser drops the dead SPA context and the
 * SW serves the pre-cached /worship document.
 *
 ...
 * (/worship, controllers, share, docs, login, projection) do not mount this.
 */
