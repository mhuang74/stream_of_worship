...
export const songsetsBundle = bundle({
  en: {
    ...
    "songsets.menu.downloadOffline": "Download for Offline",
    "songsets.menu.redownloadOffline": "Re-download for Offline",
    "songsets.menu.downloadingOffline": "Downloading for Offline…",
    "songsets.toast.offlineRemoved": "Removed offline copy — storage reclaimed",
    "songsets.toast.downloadingOffline": "Downloading for offline",
    "songsets.toast.offlineReady": "Ready for offline playback",
  ...
  "zh-Hant": {
    ...
    "songsets.menu.downloadOffline": "下載離線副本",
    "songsets.menu.redownloadOffline": "重新下載離線副本",
    "songsets.menu.downloadingOffline": "正在下載離線副本…",
    "songsets.toast.offlineRemoved": "已移除離線副本，釋放儲存空間",
    "songsets.toast.downloadingOffline": "正在下載離線副本",
    "songsets.toast.offlineReady": "已可離線播放",
