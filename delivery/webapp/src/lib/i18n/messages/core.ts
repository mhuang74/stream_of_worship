...
export const core = bundle({
  ...
  "zh-Hant": {
    ...
    "about.whyPara1": "我發現市面上缺乏為小組敬拜設計的工具。我們熱愛中文詩歌，但小組敬拜就只能放YouTube lyrics video, 或自己花時間校對歌詞做影片。",
    "about.whyPara2": "我住在上海時最開心的幾年來自委身與一個來自台灣的家庭教會，在那裡我漸漸認識並愛上讚美之泉（sop.org）的繁體中文詩歌。這些詩歌陪伴無數個聚會。",
    "about.whyPara3": "但每次帶領小組敬拜，我都面對同樣的問題：從 YouTube 播放讚美之泉的歌詞影片，意味著詩歌之間要處理間斷，敬拜中還要面對不可靠的網路。尷尬的停頓打斷了敬拜的流暢，斷線時的死寂破壞了當下的氛圍。我希望敬拜能流暢地進行。",
