...
export const core = bundle({
  ...
  "zh-Hant": {
    ...
    "home.signedOut.title": "Stream of Worship",
    "home.signedOut.subtitle":
      "為小組敬拜而設的音樂系統——將詩歌串成無縫詩歌集，渲染同步歌詞影片並投放至電視，讓小組一同敬拜不中斷。",
    "home.signedOut.heroTag": "為小組敬拜而設的歌詞影片",
    "home.signedOut.heroTitleLead": "帶領小組敬拜，",
    "home.signedOut.heroTitleAccent": "不再尷尬中斷。",
    "home.signedOut.heroDescription":
      "Stream of Worship 將詩歌串成無縫詩歌集，渲染同步歌詞影片，並投放至電視——讓您的小組一同敬拜，流暢不中斷。",
    ...
    "home.signedOut.feature.castDesc":
      "將歌詞影片送到電視或螢幕，讓小組每個人都能跟著唱——敬拜不再中斷。",
    ...
    "home.signedOut.ctaBottomTitle": "準備好無間斷帶領小組敬拜了嗎？",
