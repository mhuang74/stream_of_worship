...
export const core = bundle({
  en: {
    ...
    "home.signedOut.subtitle":
      "A worship music system that renders a synchronized lyrics video and casts it to the big screen, so your service flows without interruption.",
    "home.signedOut.heroTag": "Lyrics video on the big screen",
    "home.signedOut.heroTitleLead": "Lead worship with ",
    "home.signedOut.heroTitleAccent": "no awkward interruptions.",
    "home.signedOut.heroDescription":
      "Stream of Worship strings your songs into one seamless set, renders a synchronized lyrics video, and casts it to the big screen — so worship flows without awkward interruptions.",
    ...
    "home.signedOut.featuresTitle": "Everything you need to lead without interruption",
    "home.signedOut.featuresDescription":
      "From picking songs to casting the lyrics video, Stream of Worship handles the technical details so worship never has to pause.",
    ...
    "home.signedOut.feature.renderDesc":
      "Generate a synchronized lyrics video with your choice of template, resolution, and fonts — plus the audio mix for your service.",
    "home.signedOut.feature.cast": "Cast to the big screen",
    "home.signedOut.feature.castDesc":
      "Send the lyrics video to your TV or projector so the whole room can follow along — worship never has to stop.",
    ...
    "home.signedOut.step3": "Cast to the screen",
    "home.signedOut.step3Desc": "Send the lyrics video to your TV or projector from any device.",
    "home.signedOut.step4": "Lead without interruption",
    "home.signedOut.step4Desc": "Worship flows from song to song — no awkward pauses, no fumbling between tracks.",
    "home.signedOut.ctaBottomTitle": "Ready to lead worship without interruption?",
  ...
  "zh-Hant": {
    ...
    "home.signedOut.title": "Stream of Worship",
    "home.signedOut.subtitle":
      "渲染同步歌詞影片並投放至大螢幕的敬拜音樂系統——讓您的服事流暢不中斷。",
    "home.signedOut.heroTag": "大螢幕上的歌詞影片",
    "home.signedOut.heroTitleLead": "帶領敬拜，",
    "home.signedOut.heroTitleAccent": "不再尷尬中斷。",
    "home.signedOut.heroDescription":
      "Stream of Worship 將詩歌串成無縫詩歌集，渲染同步歌詞影片，並投放至大螢幕——讓敬拜流暢不中斷。",
    "home.signedOut.ctaPrimary": "免費開始使用",
    "home.signedOut.ctaSecondary": "登入",
    "home.signedOut.ctaFooter": "無需信用卡 · 個人使用免費",
    "home.signedOut.featuresTitle": "無間斷帶領所需的一切",
    "home.signedOut.featuresDescription":
      "從選歌到投放歌詞影片，Stream of Worship 處理技術細節，讓敬拜不再停頓。",
    "home.signedOut.feature.build": "建立詩歌集",
    "home.signedOut.feature.buildDesc":
      "從 300+ 首敬拜詩歌曲目中精選。重新排序、調整調性，打造您的詩歌集後再渲染。",
    "home.signedOut.feature.render": "渲染歌詞影片",
    "home.signedOut.feature.renderDesc":
      "生成同步歌詞影片，可選擇模板、解析度與字體——以及服事所需的音訊混音。",
    "home.signedOut.feature.cast": "投放至大螢幕",
    "home.signedOut.feature.castDesc":
      "將歌詞影片送到電視或投影機，讓全會眾跟著唱——敬拜不再中斷。",
    ...
    "home.signedOut.step3": "投放至螢幕",
    "home.signedOut.step3Desc": "從任何裝置將歌詞影片送到電視或投影機。",
    "home.signedOut.step4": "無間斷帶領",
    "home.signedOut.step4Desc": "敬拜從一首詩歌流暢銜接至下一首——不再尷尬停頓，無需在詩歌間手忙腳亂。",
    "home.signedOut.ctaBottomTitle": "準備好無間斷帶領敬拜了嗎？",
    "home.signedOut.ctaBottomDesc": "加入使用 Stream of Worship 投放歌詞的敬拜帶領者。",
