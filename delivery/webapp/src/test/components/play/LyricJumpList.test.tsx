...
describe("LyricJumpList", () => {
  ...
  const defaultProps = {
    ...
    currentTime: 25,
    currentSongIndex: 0,
    onJumpToChapter: mockJumpToChapter,
  ...
  describe("interactions", () => {
    ...
    it("calls onJumpToChapter when chapter is clicked", async () => {
      render(<LyricJumpList {...defaultProps} />);
      ...
      expect(mockJumpToChapter).toHaveBeenCalledWith(1);
    });
