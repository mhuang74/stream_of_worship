...
Locus for all work: `delivery/render-worker/` + `.github/workflows/`.

Reference spec: `delivery/render-worker/specs/vendor-ffmpeg-via-r2-v2.md`.
...
**File:** `delivery/render-worker/tests/test_docker.py`
...
**New file:** `delivery/render-worker/scripts/upload-ffmpeg-to-r2.sh`
...
# export SOW_R2_* credentials (or source from delivery/render-worker/.env)
...
**File:** `delivery/render-worker/scripts/download-ffmpeg.sh`
