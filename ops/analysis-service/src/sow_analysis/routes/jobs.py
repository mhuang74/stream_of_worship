    ...
    if job.result:
        if job.type == JobType.EMBEDDING:
            ...
            result = JobResult(
                ...
                key_algorithm_version=job.result.key_algorithm_version,
                key_score_margin=job.result.key_score_margin,
                key_window_agreement=job.result.key_window_agreement,
                key_candidates=job.result.key_candidates,
                key_detected_at=job.result.key_detected_at,
