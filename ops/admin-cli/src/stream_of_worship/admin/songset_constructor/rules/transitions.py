...
def recommend_transition(from_cand: SongCandidate, to_cand: SongCandidate) -> TransitionCandidate:
    distance = cfd(from_cand.musical_key, from_cand.musical_mode, to_cand.musical_key, to_cand.musical_mode)
    shift, shifted_distance = suggest_key_shift(
        from_cand.musical_key, from_cand.musical_mode, to_cand.musical_key, to_cand.musical_mode,
    )
