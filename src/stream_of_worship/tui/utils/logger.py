"""Error logging utility for Transition Builder app.
...
class ErrorLogger:
    ...
    def __init__(self, log_path: Optional[Path] = None, enabled: bool = True):
        ...
        Args:
            log_path: Path to log file. Defaults to ./transitions_errors.log
...
class SessionLogger:
    ...
    def __init__(self, log_path: Optional[Path] = None, enabled: bool = True):
        ...
        Args:
            log_path: Path to log file. Defaults to ./transitions_session.log
    ...
    def log_generation_complete(
        ...
        Args:
            ...
            used_stems: Whether stems were used for generation
        """
        if not self._enabled:
            return
